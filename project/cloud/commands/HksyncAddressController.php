...
set_time_limit(0);
// */1 * * * * /usr/local/bin/php /data/wwwroot/cloud/yii hksync-address runAddress >/dev/null 2>&1
class HksyncAddressController extends BaseController
{
    private static $db_huaka;
    private static $db_analysis_repertory;
    private static $db_tidb;
    private static $db_write_hk;
    ...
    public function init()
    {
        ...
        self::$db_huaka = Yii::$app->db_huaka;
        self::$db_write_hk = Yii::$app->db_write_hk;
    ...
    private function runOne($startId,$endId)
    {
        ...
        $command = self::$db_huaka->createCommand($selectSql);
        ...
        $command = self::$db_write_hk->createCommand($deleteSql);
    ...
    public function runAddress($startId = null, $endId = null)
    {
        ...
        $startFile = Yii::$app ->basePath . '/commands/rundata/hkAddressId.txt';
        if (!$startId){
        ...
        $maxIdCommand = self::$db_huaka->createCommand($maxIdSql);
