 ...
 */
class DcOrigin extends \app\models\repo\CloudBase
{
    /**
     * @inheritdoc
     */
    ...
    { 
        return [
            ...
            [['loan_id', 'user_id', 'aid', 'credit_score','tianqi_score_v2', 'model_score_v2', 'is_black'], 'integer'],
    ...
    {
        //查询永久数据
        $datetime = date('Y-m-d', strtotime('-90 day'));
        $where = ['AND',
            [
                'phone' => $data['phone'],
                'idcard' => $data['idcard'],
    ...
    public function updateOrgInfo($origin_result)
    {
        ...
        $this->tianqi_score_v2 = $origin_result['tianqi_score_v2'];
