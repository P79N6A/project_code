...
<form style="display:block;" id="uploadImgForm" name="uploadImgForm" action="/upload" method="POST"  enctype="multipart/form-data" >								
<input name="encrypt" value="<?=$encrypt?>" type="hidden">							

<div id="img1_group">

<input id="img1_ext" name="img1[ext]" value="png" type="hidden">	
