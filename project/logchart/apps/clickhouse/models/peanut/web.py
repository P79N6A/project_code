...
class web(clickhouseModel):
    ...
    def getLastTime(self):
        lastTime = self.objects_in(self.peanutModel).filter(request_time__between=['2000-01-01 00:00:00', '2100-12-31 23:59:59']).order_by('-request_time').only('request_time')
        if lastTime.count() == 0:
