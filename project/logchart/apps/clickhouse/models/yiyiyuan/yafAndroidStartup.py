...
class yafAndroidStartup(clickhouseModel):
    ...
    _sim_cardno = fields.StringField()
    _is_double_card = fields.StringField()
    _phone_status = fields.StringField()
    _call_volume = fields.StringField()
    _is_headphones = fields.StringField()
    _idfa = fields.StringField()
    _idfv = fields.StringField()
    ...
    @classmethod
    def table_name(cls):
        return 'yaf_yyy_android_startup_all'
