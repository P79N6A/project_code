 ...
 *
 * 定时采集数据地址
    D:\phpStudy\PHPTutorial\php\php-5.6.27-nts\php.exe D:\workspace\open\yii sjmh runQuerys
    定时通知地址
    D:\phpStudy\PHPTutorial\php\php-5.6.27-nts\php.exe D:\workspace\open\yii sjmh runNotify
 */
// #查询
