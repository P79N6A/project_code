...
class CONFIG {
	...
	// 正式账号
	public static $account = 'xianhh';
	public static $password = 'xianhh';
	public static $apicode = '3000095';


	// 测试账号
	// public static $account = 'xianhh_test';
	// public static $password = 'xianhh_test';
	// public static $apicode = '3100102';
	...
	public static $querys = array(
		'huaxiang' => 'https://api.100credit.cn/bankServer2/data/terData.action', //打包调用模块地址
		'haina' => 'https://api.100credit.cn/HainaApi/data/getData.action', //单独调用模块地址
	);
