...
$key_dir = \Yii::$app->basePath . '/modules/api/common/rongbao/key/prod184/';
//生产环境配置文件
return [
// 商户ID，由纯数字组成的字符串
    'merchant_id' => "100000001304472",
//md5key
    'key' => "3219ddfg00b42b0235f8c6c58a82a81e3a6aggd692013eaab3a57ba3gea34ge0",
//签约融宝支付账号或卖家收款融宝支付帐户
    'seller_email' => "liudi@ihsmf.com",
    'batch_version' => "1.0.0",
    //回调地址
    'notify_url' => 'http://open.xianhuahua.com/rongbaoback/rongbao/prod184',
    //融宝接口地址
