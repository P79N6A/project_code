...
class LianremitController extends ApiController {
    ...
    public function actionIndex() {
        ...
        if (!$resultData) {
            Logger::dayLog(
                    'lianremit/error', 'actionSaveRemitData', 'remit 数据保存失败', '提交数据', $postData, '错误原因', $this->remitModel->errinfo
            );
