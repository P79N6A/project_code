...
class YysClientNotify extends \app\models\BaseModel {
	...
	public function getRemit() {
		return $this->hasOne(JxlRequestModel::className(), ['id' => 'remit_id']);
	}
	...
	public function rules() {
		return [
			[['requestid'], 'required'],
			[['requestid', 'grab_status', 'notify_num', 'notify_status'], 'integer'],
	...
	public function attributeLabels() {
		return [
			...
			'requestid' => '请求id',
			'tip' => '通知内容',
			'grab_status' => '采集状态:2:处理中;1:成功:0:失败;',
			'notify_num' => '通知次数: 上限7次',
			'notify_status' => '通知状态:0:初始; 1:通知中; 2:通知成功;3:重试 4:通知失败 5: 通知达上限',
			'notify_time' => '下次通知时间',
			'reason' => '客户响应结果',
			'create_time' => '创建时间',
		];
	 ...
	 * @return bool
	 */
	public function saveData($requestid, $grab_status, $tip='') {
