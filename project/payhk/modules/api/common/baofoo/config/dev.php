<?php
//测试环境
$keyPath = Yii::$app->basePath.'/modules/api/common/baofoo/key/';
return [
    "version"      =>"4.0.0.0",  #版本
    ...
    "prep_pay_txn_sub_type" =>'15',  #认证支付类预支付交易（14不发短信，15发送短信）
    "confirm_pay_txn_sub_type" =>'16',  #认证支付类支付确认交易
    "query_trade_txn_sub_type" =>'31',  #交易状态查询类交易

    "member_id"    =>'100000276',  #宝付提供给商户的唯一编号
    "data_type"    =>'json',
    "biz_type"     =>'0000',#接入类型
    ...
    'pfxfilename' => $keyPath."bfkey_100000276@@100000990.pfx",  //注意证书路径是否存在
    'cerfilename' => $keyPath."bfkey_100000276@@100000990.cer",//注意证书路径是否存在

    // 操作url
    "action_url" => 'https://tgw.baofoo.com/cutpayment/api/backTransRequest',
    //查询
    "query_url" =>'https://vgw.baofoo.com/cutpayment/api/backTransRequest',
];