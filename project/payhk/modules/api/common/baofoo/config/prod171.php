<?php
//生产环境
$keyPath = Yii::$app->basePath."/modules/api/common/baofoo/key/171/";
return [
    "version" => "4.0.0.0", // 接口版本
    "member_id" => "1223576", // 商户号
    "terminal_id" => "41798", //终端号
    ...
    // 回调接口地址
    "return_url" => SYSTEM_PROD?"http://pay.xianhuahua.com/bfxy/backpay":"http://182.92.80.211:8799/bfxy/backpay",

    // 证书
    "private_key_password" => "996633",	//商户私钥证书密码
