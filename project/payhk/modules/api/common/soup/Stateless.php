...
class Stateless
{
    ...
    private function saveData(SoupStateless $oSoupStateless, $video_file, $params)
    {
        ...
        $save_data = [
            ...
            'image_timestamp'   => empty($image_timestamp) ? 0.00 : $image_timestamp,
    ...
    private function savePic($base64_image)
    {
        ...
        $image_url = SYSTEM_PROD ? Yii::$app->params["image_url"] : "http://182.92.80.211:8799/api";
        ...
        $encrypt = Crypt3Des::encrypt(json_encode($jsonstr), Yii::$app->params["img_key"]);
        ...
        $img_path = "/video/soup/".date("Y").'/'.date("m").'/'.date("d").'/'.time().".jpg";
        $params = [
            'encrypt'       => $encrypt,
