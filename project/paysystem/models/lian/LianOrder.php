 ...
 *
 */
class LianOrder extends \app\models\BasePay {
    /**
     * @inheritdoc
     */
    public static function tableName() {
        return '{{pay_lian_order}}';
    }
     ...
     * @return []
     */
    public function getPayUrls($pay_controller='lianpay', $pay_type='') {
        return parent::getPayUrls($pay_controller, Payorder::PAY_LIANLIAN);
    }
}