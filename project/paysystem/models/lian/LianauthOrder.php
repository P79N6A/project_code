 ...
 *
 */
class LianauthOrder extends \app\models\BasePay {
    /**
     * @inheritdoc
     */
    public static function tableName() {
        return '{{payauth_lian_order}}';
    }
    ...
    public function savePayBind($agreeno) {
        ...
        //3. 更新绑卡表为成功
        $oBindBank = lianauthBindbank::findOne($this->bind_id);
        if (!$oBindBank) {
            return false;
        }
     ...
     * @return []
     */
    public function getPayUrls($pay_controller="lianauthpay", $pay_type='') {
        return parent::getPayUrls($pay_controller, Payorder::PAY_LIANAUTH);
    }
