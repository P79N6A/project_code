...
/**
 * This is the model class for table "bf_remit".
 *
 * @property integer $id
 ...
 */
class BfRemit extends \app\models\open\OpenBase
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['aid', 'req_id', 'client_id','identityid', 'user_mobile', 'guest_account_name', 'guest_account_bank', 'guest_account', 'guest_account_province', 'guest_account_city', 'guest_account_bank_branch', 'callbackurl', 'create_time', 'modify_time', 'query_time'], 'required'],
            ...
            [['req_id', 'batch_no', 'bf_orderid'], 'string', 'max' => 40],
