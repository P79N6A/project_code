...
/**
 * This is the model class for table "remit_notify".
 *
 * @property integer $id
 ...
 */
class RemitNotify extends \app\models\BaseModel {
    // 通知状态
   ...
   /**
    ...
    {
        return [
            [['aid', 'tip', 'notify_time', 'create_time'], 'required'],
            [['aid', 'remit_status', 'notify_num', 'notify_status', 'channel_id'], 'integer'],
            [['notify_time', 'create_time','auth_time','remit_time'], 'safe'],
            [['settle_amount'], 'number'],
            [['req_id', 'client_id'], 'string', 'max' => 50],
    ...
    public function saveData($postdata) {
        ...
        $row = [
            ...
            'channel_id' => ArrayHelper::getValue($postdata,'channel_id',0),           
            'settle_amount' => ArrayHelper::getValue($postdata,'settle_amount'),           
            'remit_time' => ArrayHelper::getValue($postdata,'remit_time'),           
            'auth_time' => ArrayHelper::getValue($postdata,'auth_time','0000-00-00 00:00:00'),           
            'notify_num' => 0,
            'notify_status' => 0,
            'notify_time' => $dayTime,
            'create_time' => $dayTime,
