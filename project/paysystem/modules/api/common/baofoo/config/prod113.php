<?php
//生产环境
$keyPath = Yii::$app->basePath.'/modules/api/common/baofoo/key/113/';
return [
    "version"      =>"4.0.0.0",  #版本
    "terminal_id"  =>'34990',   #终端号
    "txn_type"     =>'0431',   #交易类型
    //代扣
    ...
    "member_id"    =>'1174635',  #宝付提供给商户的唯一编号
    "data_type"    =>'json',
    "biz_type"     =>'0000',#接入类型
    ...
    //余额查询
    'b_terminal_id' => '34989',//网银终端号
    'Key' => '8qlylhxf6ueb46gk',//MD5Key
