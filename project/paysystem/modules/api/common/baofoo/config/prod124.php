<?php
//生产环境
$keyPath = Yii::$app->basePath.'/modules/api/common/baofoo/key/124/';
return [
    "version"      =>"4.0.0.0",  #版本
    "terminal_id"  =>'35681',   #终端号
    "txn_type"     =>'0431',   #交易类型
    //代扣
    ...
    "member_id"    =>'1183344',  #宝付提供给商户的唯一编号
    "data_type"    =>'json',
    "biz_type"     =>'0000',#接入类型
    ...
    //余额查询
    'b_terminal_id' => '35679',//网银终端号
    'Key' => 'j6cxughd9m2zluet',//MD5Key
