...
class PaymentController extends ApiController {
    ...
    private function route($oPayorder, &$postData) {
        ...
        // 上海易旨微信  139 140 正常  141 142 逾期还款
        case 139:
        case 141:
            $oPay = new Repayment($oPayorder['channel_id']);
            $res = $oPay->createwxOrder($oPayorder);
            break;
        //新增微信支付 149 正常 益倍加
        case 149:
        case 155:
        case 156:
            $oPay = new Repaywx($oPayorder['channel_id']);
            $res = $oPay->createwxOrder($oPayorder);
            break;
        ...
        case 153:
        case 154:
            $oPay = new Repayali($oPayorder['channel_id']);
        ...
        case 174:
             ...
             $oPay = new Cjpayment($oPayorder['channel_id']);
             $res = $oPay->createOrder($oPayorder, ArrayHelper::getValue($postData, 'source', 0));//写入次表
             break;
        default:
