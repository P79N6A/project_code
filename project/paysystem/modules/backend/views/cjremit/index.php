...
$this->title = "支付系统";
$status      = \app\models\open\Cjremit::getStatus();
...
<div class="col-lg-12 ui-sortable">
    <div class="box ui-sortable-handle" style="position: relative; left: 0px; top: 0px;">
        ...
        <div class="body">
            <form action="/backend/cjremit/index" method="GET" class="form-inline">
...
<!--                                <td>--><?//= $val['guest_account_name'] ?><!--</td>-->
                                ...
                                <td>
                                    <a href="/backend/cjremit/update?id=<?= $val['id'] ?>">
