...
// 路径
    ...
    <head>
        ...
        <title><?= $this->title ?>-支付出款路由系统</title>
                ...
                <nav class="navbar navbar-inverse <?= isset($fix) ? $fix : 'navbar-static-top'; ?>">
                    <div class="container-fluid">
                        ...
                        <div class="topnav">
                            ...
                            <div class="btn-group">
                                <a href="/backend/manager/update-password" data-placement="bottom" data-original-title="update password" data-toggle="tooltip" class="btn btn-default btn-sm" id="toggleFullScreen">
                                    <i class="glyphicon glyphicon-wrench"></i>
                                </a>
                            </div>
                            <div class="btn-group">
                                <a href="/backend/manager/reset-password"  data-placement="bottom" data-original-title="reset password" data-toggle="tooltip" class="btn btn-default btn-sm" id="toggleFullScreen">
                                    <i class="glyphicon glyphicon-wrench"></i>
                                </a>
                            </div>
                            <div class="btn-group">
                                <a href="/backend/default/logout" data-toggle="tooltip" data-original-title="Logout" data-placement="bottom" class="btn btn-metis-1 btn-sm">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                <?php
                                $navs        = [
                                    ['name' => '主页', 'url' => '/backend/pay?aid=0', 'nav' => 'pay0'],
                                    ['name' => '一亿元', 'url' => '/backend/pay?aid=1', 'nav' => 'pay'],
                                    ['name' => '花生米富', 'url' => '/backend/pay?aid=4', 'nav' => 'pay4'],
                                    ['name' => '7-14项目', 'url' => '/backend/pay?aid=8', 'nav' => 'pay8'],
                                    ['name' => '米花花', 'url' => '/backend/pay?aid=9', 'nav' => 'pay9'],
                                    ['name' => '有信令', 'url' => '/backend/pay?aid=10', 'nav' => 'pay10'],
//                                    ['name' => '一亿元新商城', 'url' => '/backend/pay?aid=14', 'nav' => 'pay14'],
                                    ['name' => '新借款系统', 'url' => '/backend/pay?aid=16', 'nav' => 'pay16'],
                                    ['name' => '先花一个亿', 'url' => '/backend/pay?aid=17', 'nav' => 'pay17'],
                                ];
