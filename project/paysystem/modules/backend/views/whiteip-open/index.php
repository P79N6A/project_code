...
$this->title="支付系统";
$status = \app\models\open\WhiteIpOpen::getStatus(); 
?>
<div class="col-lg-12 ui-sortable">
    <div class="box ui-sortable-handle" style="position: relative; left: 0px; top: 0px;">
        <header>
        <h5>IP白名单</h5>
        <a href="/backend/whiteip-open/add"><label style="float:right" class="btn btn-primary">添加</label></a>
        </header>
        <div class="body">
