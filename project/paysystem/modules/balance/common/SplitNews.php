...
use app\modules\balance\models\yyy\QjLoanRepay;
use app\modules\balance\models\yyy\QjUserLoan;
use app\modules\balance\models\yyy\QjUserRemitList;
...
//            $this->oPaymentDetails->saveOneCollectionStatus($oCollection,$this->oPaymentDetails->gStatus('STATUS_FAILURE'), "借款表查询失败");
        ...
        //实例化  实际出款表
        $oUserRemitList = new QjUserRemitList();
...
//            'coupon_amount'                 => $coupon_amount, //优惠卷
