...
class UploadchannelController extends  AdminController
{
   /* public $vvars = [
        'menu' => 'pay',
        'nav' =>'pay',
        ...
        if ($this->isPost()){
            ...
            if (strpos($file_info, 'xls') > 0){
                ...
                $data_set = [
                    ...
                    'type'          => 2,//1:体外放款，2：体外回款
                    'start_time'    => ArrayHelper::getValue($post_data, 'start_time'),
                    'end_time'      => ArrayHelper::getValue($post_data, 'end_time'),
                ];
