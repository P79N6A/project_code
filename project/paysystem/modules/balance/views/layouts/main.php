                ...
                <nav class="navbar navbar-inverse <?= isset($fix) ? $fix : 'navbar-static-top'; ?>">
                    <div class="container-fluid">
                        ...
                        <div class="topnav">
                            ...
                            -->
                            <div class="btn-group">
                                <a href="/balance/default/logout" data-toggle="tooltip" data-original-title="Logout" data-placement="bottom" class="btn btn-metis-1 btn-sm">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                <?php
                                $navs        = [
                                    ['name' => '一亿元', 'url' => '/balance/default/index', 'nav' => 'default'],
                                    ['name' => '智融钥匙', 'url' => '/balance/zrys/index', 'nav' => 'zrys'],
                                    ['name' => '财务核算', 'url' => '/balance/account/index', 'nav' => 'account'],
                                    ['name' => '体外回款对账', 'url' => '/balance/channelcount/index', 'nav' => 'channelcount'],
                                    ['name' => '体外出款对账', 'url' => '/balance/paidcount/index', 'nav' => 'paid'],
                                ];
