...
//url地址
$action_url = '/balance/uploadchannel/upbill';
$jump_url = '/balance/uploadchannel/list';
$down_model = '/balance/uploadchannel/downmodel';
?>
        ...
        <div class="body">
            <form enctype="multipart/form-data" id="post_form" method="post" action="<?=$action_url?>" >
                ...
                <table class="table table-bordered" style="width: 70%;">
                    ...
                    <tr>
                        <td style="width: 30%; height: 50px; text-align:center;vertical-align:middle;">账单日期范围</td>
                        <td>
                            <input style="margin-right: 10px;width: 100px;" type="text" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" name="start_time" value=""  /> ~
                            <input style="margin-left: 10px;width: 100px;"  type="text" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" name="end_time"  value="" />
                        </td>
