...
<div class="col-lg-12 ui-sortable">
    <div class="box ui-sortable-handle" style="position: relative; left: 0px; top: 0px;">
        ...
        <div class="body">
            <form action="/policyment/bill/diffindex" method="GET" class="form-inline">
                    ...
                    <?php if (!empty($res)): ?>
                        <?php foreach ($res as $key => $val): ?>
                            <tr role="row" class="even">
                                ...
                                <td><span style="color:red"><?= $val['policy_diff_number'] ?></span></td>
                                <td><?= $val['policy_diff_premium'] ?></td>
                                <td><span style="color:red"><?= $val['bill_diff_number'] ?></span></td>
                                <td><?= $val['bill_diff_premium'] ?></td>
