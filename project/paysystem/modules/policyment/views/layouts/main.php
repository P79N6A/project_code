    ...
    <body class="bg-dark dk">
        <div class="bg-dark dk" id="wrap">
                ...
                <nav class="navbar navbar-inverse <?= isset($fix) ? $fix : 'navbar-static-top'; ?>">
                    <div class="container-fluid">
                        ...
                        <div class="topnav">
                            ...
                            -->
                            <div class="btn-group">
                                <a href="/policyment/default/logout" data-toggle="tooltip" data-original-title="Logout" data-placement="bottom" class="btn btn-metis-1 btn-sm">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                <?php
                                $navs        = [
                                    ['name' => '主页', 'url' => '/policyment/policy', 'nav' => 'pay'],
            ...
            <!-- /#top -->
                ...
                <div id="left">
                    <?php include __dir__ . '/menus/default.php'; ?>
                </div>
                <!-- /#left -->
