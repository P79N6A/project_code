...
<div class="col-lg-12 ui-sortable">
    <div class="box ui-sortable-handle" style="position: relative; left: 0px; top: 0px;">
        <header>
            <h5><?php echo $this->title. '>'?>上传对账单</h5>
            <span id="click_href_up"  class="btn btn-primary" style="margin: 2px 10px 0 0;float: right;">返回</span>
        </header>
        <div class="body">
            <form enctype="multipart/form-data" id="post_form" method="post" action="/settlement/upbill/upfile" >
            <input name="_csrf" type="hidden" id="_csrf" value="<?= \Yii::$app->request->csrfToken ?>">
            <table class="table table-bordered" style="width: 70%;">
                <tr>
                    <td style="width: 30%; height: 50px; text-align:center;vertical-align:middle;">出款通道</td>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td style="text-align:center;vertical-align:middle; width: 150px;"><a href="/settlement/upbill/downmodel">下载模版文件</a></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <!--
                        <button id="button_cancel" class="btn btn-primary" style="background-color: white; color: black; margin-right: 10px">取消</button>
                        <button id="button_submit" class="btn btn-primary">确认</button>-->
                    </td>
                </tr>
            </table>
            </form>
...
<script>
    $(function(){
        ...
        $("#click_href_up").click(function(){
            location.href = "/settlement/upbill/index";
        });
        //取消
