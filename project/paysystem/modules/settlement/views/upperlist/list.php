    ...
    <div class="box ui-sortable-handle" style="position: relative; left: 0px; top: 0px;">
        ...
        <div class="body">
            ...
            <div style="margin-bottom: 10px">
                <div>
                商户订单号：  <input name="client_id" type="text"  style="margin-right: 10px;margin-left:10px" value="<?=ArrayHelper::getValue($getData, 'client_id', '')?>"/>
                收款人：      <input name="guest_account_name" type="text" style="margin-right: 10px;" value="<?=ArrayHelper::getValue($getData, 'guest_account_name', '')?>" />
                ...
                <?php
                    if (!empty($result)){
                        ...
                        foreach($result as $value) {
                            ...
                            <tr role="row">
                                <td><?=$i?></td>
                                <td><?=\yii\helpers\ArrayHelper::getValue($passageOfMoney, $value->channel_id, '')?></td>
...
$(function(){
    ...
    $("#down_url").click(function(){
        location.href="/settlement/upperlist/down?"+url_params;
    });
})
</script>