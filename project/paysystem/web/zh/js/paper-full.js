...
function(t) {
    ...
    function() {
        function n(t, n, i, r, a) {
            function o(s, o) {
                ...
                "string" == typeof o && "#" === o[0] && (o = t[o.substring(1)] || o);
                var l,
                d = "function" == typeof o,
                f = o,
                ...
                a && _ || (d && _ && (o.base = _), d && r !== !1 && (l = s.match(/^([gs]et|is)(([A-Z])(.*))$/)) && (h[l[3].toLowerCase() + l[4]] = l[2]), f && !d && f.get && "function" == typeof f.get && e.isPlainObject(f) || (f = {
                    ...
                    configurable: !0
                }).configurable && (f.configurable = !0, f.enumerable = i), c(t, s, f))
            }
            var h = {};
            if (n) {
                ...
                for (var l in h) {
                    var d = h[l],
                    f = t["set" + d],
                    _ = t["get" + d] || f && t["is" + d]; ! _ || r !== !0 && 0 !== _.length || o(l, {
                        get: _,
                        set: f
                    })
                }
        ...
        function i(t, e, n) {
            return t && ("length" in t && !t.getLength && "number" == typeof t.length ? a: o).call(t, e, n = n || t),
            n
        }
        function r(t, e) {
        ...
        function(t, e, n) {
            return (n.get || n.set) && t.__defineGetter__ ? (n.get && t.__defineGetter__(e, n.get), n.set && t.__defineSetter__(e, n.set)) : t[e] = n.value,
            t
        },
        c = function(t, e, n) {
            return delete t[e],
        ...
        !0).inject({
            ...
            statics: {
                ...
                pick: function() {
                    for (var e = 0, n = arguments.length; n > e; e++) if (arguments[e] !== t) return arguments[e]
                }
            }
        })
    };
    ...
    e.inject({
        toString: function() {
            return null != this._id ? (this._class || "Object") + (this._name ? " '" + this._name + "'": " @" + this._id) : "{ " + e.each(this, 
            function(t, e) {
                if (!/^_/.test(e)) {
                    var n = typeof t;
        ...
        _set: function(n, i) {
            if (n && e.isPlainObject(n)) {
                var r = n._filtering || n;
                for (var s in r) if (s in this && r.hasOwnProperty(s) && (!i || !i[s])) {
                    var a = n[s];
                    a !== t && (this[s] = a)
                }
                return ! 0
        ...
        statics: {
            ...
            extend: function ie() {
                ...
                return n && !e.exports[n] && (e.exports[n] = t),
                t
            },
            equals: function(t, n) {
                function i(t, e) {
            ...
            readNamed: function(n, i, r, s, a) {
                ...
                if (h) {
                    var u = n._filtered;
                    u || (u = n._filtered = e.create(n[0]), u._filtering = n[0]),
                    u[i] = t
                }
            ...
            getNamed: function(n, i) {
                var r = n[0];
                return n._hasObject === t && (n._hasObject = 1 === n.length && e.isPlainObject(r)),
                n._hasObject ? i ? r[i] : n._filtered || r: t
            },
            hasNamed: function(t, e) {
                return !! this.getNamed(t, e)
            },
            isPlainValue: function(t) {
                return this.isPlainObject(t) || Array.isArray(t)
            },
            serialize: function(t, n, i, r) {
                ...
                if (o && (n.formatter = new a(n.precision), r = {
                    ...
                    s = t._serialize(n, r);
                    var h = t._class; ! h || i || s._compact || s[0] === h || s.unshift(h)
            ...
            deserialize: function(t, n, i) {
                ...
                Array.isArray(t)) {
                    ...
                    if (o) i.dictionary = r[0];
                        ...
                        var l = r;
                        n ? r = n(a, l, s) : (r = e.create(a.prototype), a.apply(r, l))
                    }
                } else if (e.isPlainObject(t)) {
                    r = {};
            ...
            importJSON: function(t, n) {
                return e.deserialize("string" == typeof t ? JSON.parse(t) : t, 
                function(t, i, r) {
                    var s = n && n.constructor === t ? n: e.create(t.prototype),
                    a = s === n;
                    if (!r && 1 === i.length && s instanceof y && (!(s instanceof x) || a)) {
                        var o = i[0];
    ...
    var n = {
        attach: function(n, i) {
            if ("string" != typeof n) return e.each(n, 
            function(t, e) {
                this.attach(e, t)
            },
            this),
            ...
            if (r) {
                ...
                s = s[n] = s[n] || [],
                -1 == s.indexOf(i) && (s.push(i), r.install && 1 == s.length && r.install.call(this, n))
            }
        },
        detach: function(n, i) {
            if ("string" != typeof n) return e.each(n, 
            ...
            s && a && (!i || -1 != (r = a.indexOf(i)) && 1 == a.length ? (s.uninstall && s.uninstall.call(this, n), delete this._handlers[n]) : -1 != r && a.splice(r, 1))
        },
        once: function(t, e) {
            this.attach(t, 
            function() {
        ...
        fire: function(t, e) {
            ...
            if (!n) return ! 1;
            for (var i = [].slice.call(arguments, 1), r = this, s = 0, a = n.length; a > s; s++) if (n[s].apply(r, i) === !1 && e && e.stop) {
                e.stop();
                break
            }
            return ! 0
    ...
    r = e.extend({
        ...
        initialize: function se(t) {
            ...
            this.project = null, this.projects = [], this.tools = [], this.palettes = [], this._id = t && (t.getAttribute("id") || t.src) || "paperscope-" + se._id++, t && t.setAttribute("id", this._id), se._scopes[this._id] = this, !this.support) {
                var e = Q.getContext(1, 1);
        ...
        execute: function(t) {
            paper.PaperScript.execute(t, this),
            Z.updateFocus()
        },
        install: function(t) {
            var n = this;
            e.each(["project", "view", "tool"], 
            function(i) {
                e.define(t, i, {
                    configurable: !0,
                    get: function() {
        ...
        function() {
            ...
            return {
                ...
                _id: 0,
                get: function(t) {
                    return t && t.getAttribute && (t = t.getAttribute("id")),
                    this._scopes[t] || null
                },
                getAttribute: t("get"),
                hasAttribute: t("has")
    ...
    s = e.extend(n, {
        ...
        activate: function() {
            ...
            return t && t !== this && t.fire("deactivate"),
    ...
    function() {
        function e(e, n, i) {
            ...
            o = 0;
            return function(t) {
                return (r || t > s && a > t) && (e[o++] = n > t ? n: t > i ? i: t),
                o
            }
        }
        ...
        return {
            ...
            integrate: function(t, e, r, s) {
                for (var a = n[s - 2], o = i[s - 2], h = .5 * (r - e), u = h + e, l = 0, c = s + 1 >> 1, d = 1 & s ? o[l++] * t(u) : 0; c > l;) {
                    var f = h * a[l];
                    d += o[l++] * (t(u + f) + t(u - f))
                }
                return h * d
            ...
            findRoot: function(t, e, n, i, s, a, o) {
                for (var h = 0; a > h; h++) {
                    ...
                    c = n - l;
                    if (r(l) < o) return c;
                    u > 0 ? (s = n, n = i >= c ? .5 * (i + s) : c) : (i = n, n = c >= s ? .5 * (i + s) : c)
                }
                return n
            },
            solveQuadratic: function(t, n, i, a, o, h) {
                var u = e(a, o, h);
                if (r(t) < c) return r(n) >= c ? u( - i / n) : r(i) < c ? -1: 0;
                var l = n / (2 * t),
                d = i / t,
                f = l * l;
                if (d - c > f) return 0;
    ...
    h = e.extend({
        ...
        getAngleInRadians: function() {
            if (arguments.length) {
                ...
                return o.isZero(e) ? 0 / 0: Math.acos(this.dot(t) / e)
            }
    ...
    },
    {
        ...
        normalize: function(e) {
            ...
            return i >= 0 && (r._angle = this._angle),
            r
        },
        rotate: function(t, e) {
            ...
            i = Math.sin(t),
            r = Math.cos(t);
            return n = new h(n.x * r - n.y * i, n.x * i + n.y * r),
            e ? n.add(e) : n
        },
    ...
    f = e.extend({
        ...
        initialize: function(n, i, r, s) {
            ...
            if ("number" === a ? (this.x = n, this.y = i, this.width = r, this.height = s, o = 4) : "undefined" === a || null === n ? (this.x = this.y = this.width = this.height = 0, o = null === n ? 1: 0) : 1 === arguments.length && (Array.isArray(n) ? (this.x = n[0], this.y = n[1], this.width = n[2], this.height = n[3], o = 1) : n.x !== t || n.width !== t ? (this.x = n.x || 0, this.y = n.y || 0, this.width = n.width || 0, this.height = n.height || 0, o = 1) : n.from === t && n.to === t && (this.x = this.y = this.width = this.height = 0, this._set(n), o = 1)), !o) {
                ...
                if (this.x = u.x, this.y = u.y, l && l.x !== t || e.hasNamed(arguments, "to")) {
                    ...
                    this.width = d.x - u.x,
                    this.height = d.y - u.y,
                    this.width < 0 && (this.x = d.x, this.width = -this.width),
                    this.height < 0 && (this.y = d.y, this.height = -this.height)
                } else {
        ...
        setSize: function() {
            var t = c.read(arguments);
            this._fixX && (this.x += (this.width - t.width) * this._fixX),
            this._fixY && (this.y += (this.height - t.height) * this._fixY),
            this.width = t.width,
        ...
        setRight: function(e) {
            ...
            this._fixW ? this.x = e - this.width: this.width = e - this.x,
            this._fixX = 1
        },
        getBottom: function() {
        ...
        setBottom: function(e) {
            ...
            this._fixH ? this.y = e - this.height: this.height = e - this.y,
            this._fixY = 1
        },
        getCenterX: function() {
    ...
    new
    function() {
        return e.each([["Top", "Left"], ["Top", "Right"], ["Bottom", "Left"], ["Bottom", "Right"], ["Left", "Center"], ["Top", "Center"], ["Right", "Center"], ["Bottom", "Center"]], 
        function(t, e) {
            var n = t.join(""),
            i = /^[RL]/.test(n);
            e >= 4 && (t[1] += i ? "Y": "X");
    ...
    function() {
        var t = f.prototype;
        return e.each(["x", "y", "width", "height"], 
        function(t) {
        ...
        e.each(["Point", "Size", "Center", "Left", "Top", "Right", "Bottom", "CenterX", "CenterY", "TopLeft", "TopRight", "BottomLeft", "BottomRight", "LeftCenter", "TopCenter", "RightCenter", "BottomCenter"], 
        function(e) {
            var n = "set" + e;
            this[n] = function() {
                this._dontNotify = !0,
    ...
    g = e.extend({
        ...
        initialize: function ae(t) {
            ...
            n = !0;
            if (6 === e ? this.set.apply(this, arguments) : 1 === e ? t instanceof ae ? this.set(t._a, t._c, t._b, t._d, t._tx, t._ty) : Array.isArray(t) ? this.set.apply(this, t) : n = !1: 0 === e ? this.reset() : n = !1, !n) throw Error("Unsupported matrix parameters")
        },
        ...
        translate: function() {
            ...
            e = t.x,
            n = t.y;
            return this._tx += e * this._a + n * this._b,
        ...
        concatenate: function(t) {
            ...
            i = this._c,
            r = this._d;
            return this._a = t._a * e + t._c * n,
            this._b = t._b * e + t._d * n,
            this._c = t._a * i + t._c * r,
            this._d = t._b * i + t._d * r,
            this._tx += t._tx * e + t._ty * n,
            this._ty += t._tx * i + t._ty * r,
            this._changed(),
            this
        },
        preConcatenate: function(t) {
            ...
            s = this._tx,
            a = this._ty;
            return this._a = t._a * e + t._b * i,
            this._b = t._a * n + t._b * r,
            this._c = t._c * e + t._d * i,
            this._d = t._c * n + t._d * r,
            this._tx = t._a * s + t._b * a + t._tx,
            this._ty = t._c * s + t._d * a + t._ty,
            this._changed(),
            this
        },
        isIdentity: function() {
        ...
        transform: function(t, e, n, i, r) {
            return arguments.length < 5 ? this._transformPoint(h.read(arguments)) : this._transformCoordinates(t, e, n, i, r)
        },
        _transformPoint: function(t, e, n) {
            var i = t.x,
            r = t.y;
            return e || (e = new h),
            e.set(i * this._a + r * this._b + this._tx, i * this._c + r * this._d + this._ty, n)
        },
        _transformCoordinates: function(t, e, n, i, r) {
            for (var s = e, a = i, o = s + 2 * r; o > s;) {
                var h = t[s++],
                u = t[s++];
                n[a++] = h * this._a + u * this._b + this._tx,
                n[a++] = h * this._c + u * this._d + this._ty
            }
            return n
        },
        ...
        _inverseTransform: function(t, e, n) {
            ...
            s = t.y - this._ty;
            return e || (e = new h),
            e.set((r * this._d - s * this._b) / i, (s * this._a - r * this._c) / i, n)
        },
        decompose: function() {
            var t = this._a,
            e = this._b,
    ...
    p = e.extend({
        ...
        initialize: function(t, e, n, i, r) {
            var s = !1;
            arguments.length >= 4 ? (this._px = t, this._py = e, this._vx = n, this._vy = i, s = r) : (this._px = t.x, this._py = t.y, this._vx = e.x, this._vy = e.y, s = n),
        ...
        statics: {
            intersect: function(t, e, n, i, r, s, a, u, l, c) {
                ...
                if (!o.isZero(d)) {
                    ...
                    g = (a * _ - u * f) / d,
                    p = (n * _ - i * f) / d;
                    if ((c || g >= 0 && 1 >= g) && (c || p >= 0 && 1 >= p)) return new h(t + g * n, e + g * i)
                }
            },
            getSide: function(t, e, n, i, r, s, a) {
                ...
                h = s - e,
                u = o * i - h * n;
                return 0 === u && (u = o * n + h * i, u > 0 && (o -= n, h -= i, u = o * n + h * i, 0 > u && (u = 0))),
                0 > u ? -1: u > 0 ? 1: 0
            },
    ...
    v = s.extend({
        ...
        addChild: function(t) {
            return t instanceof x ? (e.splice(this.layers, [t]), this.activeLayer || (this.activeLayer = t)) : t instanceof y ? (this.activeLayer || this.addChild(new x(y.NO_INSERT))).addChild(t) : t = null,
            t
        },
        ...
        hitTest: function() {
            for (var t = h.read(arguments), n = P.getOptions(e.read(arguments)), i = this.layers.length - 1; i >= 0; i--) {
                var r = this.layers[i].hitTest(t, n);
                if (r) return r
            }
            return null
        },
        ...
        draw: function(t, n, i) {
            ...
            for (var r = new e({
                ...
                trackTransforms: !0,
                transforms: [n]
            }), s = 0, a = this.layers.length; a > s; s++) this.layers[s].draw(t, r);
            if (t.restore(), this._selectedItemCount > 0) {
                t.save(),
                t.strokeWidth = 1;
                for (var o in this._selectedItems) {
                    var u = this._selectedItems[o],
                    l = u._globalMatrix,
                    c = this._scope.settings.handleSize,
                    d = c / 2;
                    if (u._updateVersion === this._updateVersion && (u._drawSelected || u._boundsSelected) && l) {
                        var f = u.getSelectedColor() || u.getLayer().getSelectedColor();
                        if (t.strokeStyle = t.fillStyle = f ? f.toCanvasStyle(t) : "#009dec", u._drawSelected && u._drawSelected(t, l), u._boundsSelected) {
                            var _ = l._transformCorners(u.getInternalBounds());
                            t.beginPath();
                            for (var s = 0; 8 > s; s++) t[0 === s ? "moveTo": "lineTo"](_[s], _[++s]);
                            t.closePath(),
                            t.stroke();
                            for (var s = 0; 8 > s; s++) t.fillRect(_[s] - d, _[++s] - d, c, c)
                        }
                    }
                }
                t.restore()
    ...
    y = e.extend(n, {
        statics: {
            extend: function ue(t) {
                return t._serializeFields && (t._serializeFields = new e(this.prototype._serializeFields, t._serializeFields)),
        ...
        _initialize: function(t, e) {
            var n = t && t.internal === !0,
            i = this._matrix = new g,
            r = paper.project;
            return n || (this._id = y._id = (y._id || 0) + 1),
            this._applyMatrix = this._canApplyMatrix && paper.settings.applyMatrix,
            e && i.translate(e),
            i._owner = this,
            this._style = new F(r._currentStyle, this, r),
            this._project || (n || t && t.insert === !1 ? this._setProject(r) : (r.activeLayer || new x).addChild(this)),
            t && t !== y.NO_INSERT ? this._set(t, {
                insert: !0
            }) : !0
        },
        _events: new
        function() {
            ...
            return e.each(["onMouseDown", "onMouseUp", "onMouseDrag", "onClick", "onDoubleClick", "onMouseMove", "onMouseEnter", "onMouseLeave"], 
            function(t) {
                this[t] = n
            },
            {
        ...
        setName: function(e, n) {
            ...
            if (e && this._parent) {
                for (var i = this._parent._children, r = this._parent._namedChildren, s = e, a = 1; n && i[e];) e = s + " " + a++; (r[e] = r[e] || []).push(this),
                i[e] = this
            }
            this._name = e || t,
            this._changed(128)
    ...
    e.each(["locked", "visible", "blendMode", "opacity", "guide"], 
    function(t) {
        var n = e.capitalize(t),
        t = "_" + t;
        this["get" + n] = function() {
    ...
    {}), {
        ...
        _guide: !1,
        isSelected: function() {
            if (this._selectChildren) for (var t = 0, e = this._children.length; e > t; t++) if (this._children[t].isSelected()) return ! 0;
            return this._selected
        },
        setSelected: function(t, e) {
            if (!e && this._selectChildren) for (var n = 0, i = this._children.length; i > n; n++) this._children[n].setSelected(t); (t = !!t) ^ this._selected && (this._selected = t, this._project._updateSelection(this), this._changed(129))
        },
        _selected: !1,
        ...
        setFullySelected: function(t) {
            if (this._children) for (var e = 0, n = this._children.length; n > e; e++) this._children[e].setFullySelected(t);
        ...
        getPivot: function(t) {
            ...
            if (e) {
                var n = t ? h: u;
                e = new n(e.x, e.y, this, "setAnchor")
            }
            return e
        },
        setPivot: function() {
            this._pivot = h.read(arguments),
            this._position = t
        },
        _pivot: null,
    ...
    e.each(["bounds", "strokeBounds", "handleBounds", "roughBounds", "internalBounds", "internalRoughBounds"], 
    function(t) {
        ...
        this[n] = function(e) {
            ...
            a = this._getCachedBounds(s, e, null, r);
    ...
    },
    {
        ...
        setBounds: function() {
            ...
            i = t.getCenter();
            n.translate(i),
            (t.width != e.width || t.height != e.height) && n.scale(0 != e.width ? t.width / e.width: 1, 0 != e.height ? t.height / e.height: 1),
            i = e.getCenter(),
            n.translate( - i.x, -i.y),
            this.transform(n)
        },
        _getCachedBounds: function(t, e, n, i) {
            ...
            e = e ? r ? e.clone().concatenate(r) : e: r;
            var u = this._getBounds(i || t, e, s ? this: n);
            if (s) {
        ...
        statics: {
            _clearBoundsCache: function(e) {
                if (e._boundsCache) {
                    for (var n = 0, i = e._boundsCache.list, r = i.length; r > n; n++) {
                        var s = i[n];
                        s._bounds = s._position = t,
                        s !== e && s._boundsCache && y._clearBoundsCache(s)
                    }
                    e._boundsCache = t
                }
            }
        ...
        setMatrix: function(t) {
            ...
            this._applyMatrix ? this.transform(null, !0) : this._changed(9)
        },
        getGlobalMatrix: function(t) {
            var e = this._globalMatrix,
            n = this._project._updateVersion,
            i = this.getView()._matrix;
            return e && e._updateVersion !== n && (e = null),
            e || (e = this._globalMatrix = this._matrix.clone(), e.preConcatenate(this._parent ? this._parent.getGlobalMatrix(!0) : i), e._updateVersion = n),
            t ? e: i.inverted().concatenate(e)
        },
        getApplyMatrix: function() {
            return this._applyMatrix
        },
        setApplyMatrix: function(t) { (this._applyMatrix = this._canApplyMatrix && !!t) && this.transform(null, !0)
        },
    ...
    },
    {
        ...
        getLayer: function() {
            for (var t = this; t = t._parent;) if (t instanceof x) return t;
            return null
        },
        getParent: function() {
            return this._parent
        ...
        _clone: function(n, i) {
            if (n.setStyle(this._style), this._children) for (var r = 0, s = this._children.length; s > r; r++) n.addChild(this._children[r].clone(!1), !0); (i || i === t) && n.insertAbove(this);
            ...
            return n._matrix.initialize(this._matrix),
        ...
        rasterize: function(t) {
            ...
            return l.setCanvas(o),
            l.transform((new g).translate(r.add(a.divide(2))).scale(1 / i)),
            l.insertAbove(this),
            l
        },
        contains: function() {
        ...
        hitTest: function(n, i) {
            function r(i, r) {
                var s = p["get" + r]();
                return n.subtract(s).divide(l).length <= 1 ? new P(i, g, {
                    name: e.hyphenate(r),
                    point: s
                }) : t
            }
            if (n = h.read(arguments), i = P.getOptions(e.read(arguments)), this._locked || !this._visible || this._guide && !i.guides || this.isEmpty()) return null;
            var s = this._matrix,
            a = i._totalMatrix,
            o = this.getView(),
            u = i._totalMatrix = a ? a.clone().concatenate(s) : this.getGlobalMatrix().clone().preConcatenate(o._matrix),
            l = i._tolerancePadding = new c(T._getPenPadding(1, u.inverted())).multiply(Math.max(i.tolerance, 1e - 5));
            if (n = s._inverseTransform(n), !this._children && !this.getInternalRoughBounds().expand(l.multiply(2))._containsPoint(n)) return null;
            var d,
            f,
            _ = !(i.guides && !this._guide || i.selected && !this._selected || (d = i.type) && ("string" == typeof d ? d !== e.hyphenate(this._class) : !(this instanceof d))),
            g = this;
            if (_ && (i.center || i.bounds) && this._parent) {
                var p = this.getInternalBounds();
                if (i.center && (f = r("center", "Center")), !f && i.bounds) for (var v = ["TopLeft", "TopRight", "BottomLeft", "BottomRight", "LeftCenter", "TopCenter", "RightCenter", "BottomCenter"], m = 0; 8 > m && !f; m++) f = r("bounds", v[m])
            }
            var y = !f && this._children;
            if (y) for (var w = this._getChildHitTestOptions(i), m = y.length - 1; m >= 0 && !f; m--) f = y[m].hitTest(n, w);
            return ! f && _ && (f = this._hitTest(n, i)),
            f && f.point && (f.point = s.transform(f.point)),
            i._totalMatrix = a,
            f
        },
        ...
        _hitTest: function(e, n) {
            return n.fill && this.hasFill() && this._contains(e) ? new P("fill", this) : t
        }
    },
    {
        matches: function(n) {
            ...
            for (var r in n) if (n.hasOwnProperty(r)) {
                var s = this[r],
                a = n[r];
                if (s === t && "type" === r && (s = e.hyphenate(this._class)), /^(constructor|class)$/.test(r)) {
        ...
        statics: {
            _getItems: function ce(t, e, n) {
                for (var i = n && [], r = 0, s = t && t.length; s > r; r++) {
                    var a = t[r];
                    if (a.matches(e)) {
                        if (!n) return a;
                        i.push(a)
    ...
    },
    {
        ...
        insertChildren: function(t, n, i, r) {
            ...
            if (s && n && n.length > 0) {
                ...
                for (var a = n.length - 1; a >= 0; a--) {
                    var o = n[a]; ! r || o instanceof r ? o._remove(!1, !0) : n.splice(a, 1)
                }
                e.splice(s, n, t, 0);
                for (var h = this._project, u = h && h._changes, a = 0, l = n.length; l > a; a++) {
                    var o = n[a];
                    o._parent = this,
        ...
        _insert: function(t, e, n) {
            ...
            return e._parent === this._parent && i > this._index && i--,
        ...
        _removeNamed: function() {
            ...
            n = this._name,
            i = e[n],
            r = i ? i.indexOf(this) : -1; - 1 != r && (t[n] == this && delete t[n], i.splice(r, 1), i.length ? t[n] = i[i.length - 1] : delete e[n])
        },
        ...
        removeChildren: function(t, n) {
            ...
            t = t || 0,
            n = e.pick(n, this._children.length);
        ...
        rotate: function(t) {
            return this.transform((new g).rotate(t, h.read(arguments, 1, {
                readNull: !0
            }) || this.getPosition(!0)))
        }
    },
    e.each(["scale", "shear", "skew"], 
    function(t) {
        this[t] = function() {
    ...
    {}), {
        transform: function(t, e) {
            ...
            if (l && !l.shearing && 0 === l.rotation % 90) {
                for (var c in h) {
                    var d = h[c]; (i || !d._internal) && t._transformBounds(d, d)
                }
        ...
        globalToLocal: function() {
            var t = this.getGlobalMatrix();
            return t && t._inverseTransform(h.read(arguments))
        },
        localToGlobal: function() {
            var t = this.getGlobalMatrix();
            return t && t._transformPoint(h.read(arguments))
        },
        ...
        draw: function(t, e) {
            if (this._visible && 0 !== this._opacity) {
                ...
                s = this._matrix,
                a = r[r.length - 1],
                o = a.clone().concatenate(s);
                if (o.isInvertible()) {
                    i && (r.push(this._globalMatrix = o), o._updateVersion = n);
                    var h,
                    u,
                    l,
                    d = this._blendMode,
                    ...
                    _ = "normal" === d,
                    g = te.nativeModes[d],
                    p = _ && 1 === f || e.clip || (g || _ && 1 > f) && this._canComposite();
                    if (!p) {
                        var v = this.getStrokeBounds(a);
                        if (!v.width || !v.height) return;
                        l = e.offset,
                        u = e.offset = v.getTopLeft().floor(),
                        h = t,
                        t = Q.getContext(v.getSize().ceil().add(new c(1, 1)), e.pixelRatio)
                    }
                    t.save(),
                    p ? (t.globalAlpha = f, g && (t.globalCompositeOperation = d)) : t.translate( - u.x, -u.y),
                    (p ? s: o).applyToContext(t),
                    !p && e.clipItem && e.clipItem.draw(t, e.extend({
                        clip: !0
                    })),
                    this._draw(t, e),
                    t.restore(),
                    ...
                    p || (te.process(d, t, h, f, u.subtract(l).multiply(e.pixelRatio)), Q.release(t), e.offset = l)
                }
            }
        },
    ...
    x = w.extend({
        ...
        initialize: function(n) {
            ...
            i.insert = !1,
            w.call(this, i),
            (r || r === t) && (this._project.addChild(this), this.activate())
        },
        _remove: function fe(t) {
            return this._parent ? fe.base.call(this, t) : null != this._index ? (this._project.activeLayer === this && (this._project.activeLayer = this.getNextSibling() || this.getPreviousSibling()), e.splice(this._project.layers, null, this._index, 1), this._installEvents(!1), this._project._needsUpdate = !0, !0) : !1
        },
        getNextSibling: function _e() {
            return this._parent ? _e.base.call(this) : this._project.layers[this._index + 1] || null
        },
        ...
        _insert: function ve(t, n, i) {
            return n instanceof x && !n._parent ? (this._remove(!0, !0), e.splice(n._project.layers, [this], n._index + (t ? 1: 0), 0), this._setProject(n._project, !0), this) : ve.base.call(this, t, n, i)
        }
    }),
    b = y.extend({
        _class: "Shape",
        ...
        toPath: function(n) {
            var i = new(T[e.capitalize(this._type)])({
                center: new h,
                size: this._size,
                radius: this._radius,
                insert: !1
            });
            return i.setStyle(this._style),
        ...
        _draw: function(t, e) {
            ...
            if (i || r || s) {
                var a = this._radius,
                o = this._type;
                if (e.dontStart || t.beginPath(), "circle" === o) t.arc(0, 0, a, 0, 2 * Math.PI, !0);
                else {
                    var h = a.width,
                    u = a.height,
                    l = .5522847498307936;
                    if ("ellipse" === o) {
                        ...
                        d = u * l;
                        t.moveTo( - h, 0),
                        t.bezierCurveTo( - h, -d, -c, -u, 0, -u),
                        t.bezierCurveTo(c, -u, h, -d, h, 0),
                        t.bezierCurveTo(h, d, c, u, 0, u),
                        t.bezierCurveTo( - c, u, -h, d, -h, 0)
                    } else {
                        var f = this._size,
                        ...
                        if (0 === h && 0 === u) t.rect( - _ / 2, -g / 2, _, g);
                            ...
                            d = u * l;
                            t.moveTo( - p, -v + u),
                            t.bezierCurveTo( - p, -v + d, -p + c, -v, -p + h, -v),
                            t.lineTo(p - h, -v),
                            t.bezierCurveTo(p - c, -v, p, -v + d, p, -v + u),
                            t.lineTo(p, v - u),
                            t.bezierCurveTo(p, v - d, p - c, v, p - h, v),
                            t.lineTo( - p + h, v),
                            t.bezierCurveTo( - p + c, v, -p, v - d, -p, v - u)
            ...
            s || !i && !r || (this._setStyles(t), i && (t.fill(n.getWindingRule()), t.shadowColor = "rgba(0,0,0,0)"), r && t.stroke())
        },
        _canComposite: function() {
        ...
        return {
            ...
            _hitTest: function i(n, r) {
                ...
                if (this.hasStroke()) {
                    ...
                    } else "ellipse" === a && (o = e(n, o)),
                    s = 2 * Math.abs(n.getLength() - o) <= h
                }
                return s ? new P("stroke", this) : i.base.apply(this, arguments)
            }
        }
    },
    {
        ...
        function() {
            ...
            return {
                ...
                _readEllipse: function(t) {
                    var n,
                    i;
                    if (e.hasNamed(t, "radius")) n = h.readNamed(t, "center"),
    ...
    C = y.extend({
        ...
        initialize: function(e, n) {
            this._initialize(e, n !== t && h.read(arguments, 1)) || ("string" == typeof e ? this.setSource(e) : this.setImage(e)),
        ...
        clone: function(t) {
            ...
            if (n) e.setImage(n);
                ...
                r.getContext("2d").drawImage(i, 0, 0),
                e.setCanvas(r)
            }
        ...
        setImage: function(t) {
            ...
            t.getContext ? (this._image = null, this._canvas = t) : (this._image = t, this._canvas = null),
            this._size = new c(t.naturalWidth || t.width, t.naturalHeight || t.height),
            this._context = null,
            this._changed(521)
        },
        getCanvas: function() {
        ...
        setSource: function(t) {
            function e() {
                var t = i.getView();
                t && (paper = t._scope, i.setImage(n), i.fire("load"), t.update())
            }
            var n,
            i = this;
            n = document.getElementById(t) || new Image,
            n.naturalWidth && n.naturalHeight ? setTimeout(e, 0) : (q.add(n, {
                load: e
            }), n.src || (n.src = t)),
            this.setImage(n)
        },
        ...
        getAverageColor: function(t) {
            var n,
            i;
            t ? t instanceof A ? (i = t, n = t.getBounds()) : t.width ? n = new f(t) : t.x && (n = new f(t.x - .5, t.y - .5, 1, 1)) : n = this.getBounds();
            var r = 32,
            s = Math.min(n.width, r),
            a = Math.min(n.height, r),
            o = C._sampleContext;
            o ? o.clearRect(0, 0, r + 1, r + 1) : o = C._sampleContext = Q.getContext(new c(r)),
            o.save();
            ...
            o.drawImage(this.getElement(), -this._size.width / 2, -this._size.height / 2),
            o.restore();
            for (var u = o.getImageData(.5, .5, Math.ceil(s), Math.ceil(a)).data, l = [0, 0, 0], d = 0, _ = 0, p = u.length; p > _; _ += 4) {
                var v = u[_ + 3];
                d += v,
                v /= 255,
                l[0] += u[_] * v,
        ...
        getImageData: function(t) {
            var t = f.read(arguments);
            return t.isEmpty() && (t = new f(this._size)),
    ...
    S = y.extend({
        ...
        initialize: function(e, n) {
            this._initialize(e, n !== t && h.read(arguments, 1)) || this.setSymbol(e instanceof m ? e: new m(e))
        },
        _equals: function(t) {
        ...
        clone: function(t) {
            ...
            return e.setSymbol(this._symbol),
            this._clone(e, t)
        },
        isEmpty: function() {
        ...
        _hitTest: function(t, e) {
            var n = this._symbol._definition.hitTest(t, e);
    ...
    k = e.extend({
        ...
        initialize: function(e, n, i, r, s, a) {
            ...
            u,
            l = arguments.length;
            0 === l || (1 === l ? e.point ? (o = e.point, h = e.handleIn, u = e.handleOut) : o = e: 2 === l && "number" == typeof e ? o = arguments: 3 >= l ? (o = e, h = n, u = i) : (o = e !== t ? [e, n] : null, h = i !== t ? [i, r] : null, u = s !== t ? [s, a] : null)),
            new M(o, this, "_point"),
        ...
        _changed: function(t) {
            ...
            if (e) {
                ...
                r = e._curves,
                s = this._index;
                r && (t && t !== this._point && t !== this._handleIn || !(n = r[s - 1] || e._closed && r[r.length - 1]) || n._changed(), t && t !== this._point && t !== this._handleOut || !(i = r[s]) || i._changed()),
                e._changed(25)
            }
        },
        getPoint: function() {
        ...
        setSelected: function(t, e) {
            ...
            n && i !== r && (n._updateSelection(this, r, i), n._changed(129))
        },
        getIndex: function() {
        ...
        transform: function(t) {
            this._transformCoordinates(t, Array(6), !0),
            this._changed()
        },
        _transformCoordinates: function(t, e, n) {
            ...
            t && (t._transformCoordinates(e, 0, e, 0, h / 2), a = e[0], o = e[1], n ? (i._x = a, i._y = o, h = 2, r && (r._x = e[h++] - a, r._y = e[h++] - o), s && (s._x = e[h++] - a, s._y = e[h++] - o)) : (r || (e[h++] = a, e[h++] = o), s || (e[h++] = a, e[h++] = o))),
            e
        }
    }),
    M = h.extend({
        initialize: function(e, n, i) {
            ...
            s,
            a;
            if (e) if ((r = e[0]) !== t) s = e[1];
            else {
                var o = e; (r = o.x) === t && (o = h.read(arguments), r = o.x),
                s = o.y,
                a = o.selected
            } else r = s = 0;
            this._x = r,
    ...
    z = e.extend({
        ...
        initialize: function(t, e, n, i, r, s, a, o) {
            ...
            this._segment1 = e,
            this._segment2 = n;
            else if (0 === h) this._segment1 = new k,
            this._segment2 = new k;
            else if (1 === h) this._segment1 = new k(t.segment1),
            this._segment2 = new k(t.segment2);
            else if (2 === h) this._segment1 = new k(t),
            this._segment2 = new k(e);
                ...
                c,
                d;
                4 === h ? (u = t, l = e, c = n, d = i) : 8 === h && (u = [t, e], d = [a, o], l = [n - t, i - e], c = [r - a, s - o]),
        ...
        getLength: function() {
            return null == this._length && (this._length = this.isLinear() ? this._segment2._point.getDistance(this._segment1._point) : z.getLength(this.getValues(), 0, 1)),
            this._length
        },
        getArea: function() {
        ...
        isHorizontal: function() {
            return this.isLinear() && o.isZero(this._segment1._point._y - this._segment2._point._y)
        },
        getIntersections: function(t) {
            return z.getIntersections(this.getValues(), t.getValues(), this, t, [])
        },
        ...
        divide: function(t, e, n) {
            ...
            if (i > r && 1 - r > i) {
                ...
                var c = u[6],
                d = u[7],
                f = new k(new h(c, d), !o && new h(u[4] - c, u[5] - d), !o && new h(l[2] - c, l[3] - d));
                if (this._path) this._segment1._index > 0 && 0 === this._segment2._index ? this._path.add(f) : this._path.insert(this._segment2._index, f),
                s = this;
                else {
        ...
        reverse: function() {
            return new z(this._segment2.reverse(), this._segment1.reverse())
        },
        remove: function() {
            var t = !1;
            if (this._path) {
        ...
        statics: {
            getValues: function(t, e, n) {
                ...
                return n && n._transformCoordinates(o, 0, o, 0, 6),
                o
            },
            evaluate: function(t, e, n) {
                ...
                if (0 === n && (_ > e || e > 1 - _)) {
                    ...
                    w = 3 * (c - u) - y,
                    x = f - a - y - w;
                    if (0 === n) i = ((m * e + v) * e + p) * e + s,
                    r = ((x * e + w) * e + y) * e + a;
                    else if (_ > e && o === s && u === a || e > 1 - _ && l === d && c === f ? (i = d - s, r = f - a) : _ > e ? (i = p, r = y) : e > 1 - _ ? (i = 3 * (d - l), r = 3 * (f - c)) : (i = (3 * m * e + 2 * v) * e + p, r = (3 * x * e + 2 * w) * e + y), 3 === n) {
                        var b = 6 * m * e + 2 * v,
                        C = 6 * x * e + 2 * w;
            ...
            getParameterOf: function(t, e, n) {
                ...
                for (var r, s, a = [], o = [], h = z.solveCubic(t, 0, e, a), u = z.solveCubic(t, 1, n, o), l = 0; - 1 == h || h > l;) if ( - 1 == h || (r = a[l++]) >= 0 && 1 >= r) {
            ...
            getPart: function(t, e, n) {
                return e > 0 && (t = z.subdivide(t, e)[1]),
    ...
    e.each(["getBounds", "getStrokeBounds", "getHandleBounds", "getRoughBounds"], 
    function(t) {
        this[t] = function() {
            this._bounds || (this._bounds = {});
            var e = this._bounds[t];
            return e || (e = this._bounds[t] = T[t]([this._segment1, this._segment2], !1, this._path.getStyle())),
            e.clone()
        }
    },
    {}), e.each(["getPoint", "getTangent", "getNormal", "getCurvature"], 
    function(t, e) {
        this[t + "At"] = function(t, n) {
            var i = this.getValues();
            return z.evaluate(i, n ? t: z.getParameterAt(i, t, 0), e)
        },
        this[t] = function(t) {
    ...
    },
    {
        getParameterAt: function(e, n) {
            return z.getParameterAt(this.getValues(), e, n !== t ? n: 0 > e ? 1: 0)
        },
        getParameterOf: function(t) {
            var t = h.read(arguments);
            return z.getParameterOf(this.getValues(), t.x, t.y)
        },
        getLocationAt: function(t, e) {
            return e || (t = this.getParameterAt(t)),
            new I(this, t)
        },
        getLocationOf: function(t) {
            var t = h.read(arguments),
            e = this.getParameterOf(t);
            return null != e ? new I(this, e) : null
        },
        getNearestLocation: function(t) {
            function e(e) {
                if (e >= 0 && 1 >= e) {
                    var i = t.getDistance(z.evaluate(n, e, 0), !0);
                    if (r > i) return r = i,
                    s = e,
                    !0
                }
            }
            for (var t = h.read(arguments), n = this.getValues(), i = 100, r = 1 / 0, s = 0, a = 0; i >= a; a++) e(a / i);
            for (var o = 1 / (2 * i); o > 1e - 5;) e(s - o) || e(s + o) || (o /= 2);
            var u = z.evaluate(n, s, 0);
            return new I(this, s, u, null, null, null, t.getDistance(u))
        },
        getNearestPoint: function(t) {
            var t = h.read(arguments);
            return this.getNearestLocation(t).getPoint()
        }
    }), new
    function() {
        function e(t) {
        ...
        return {
            ...
            getParameterAt: function(t, i, r) {
                function s(t) {
                    var e = n(r, t);
                    return f += t > r ? o.integrate(l, r, t, e) : -o.integrate(l, t, r, e),
                    r = t,
                    f - i
                }
                if (0 === i) return r;
                ...
                var d = i / c,
                f = 0;
                return o.findRoot(s, l, a ? h + d: u - d, h, u, 16, 1e - 5)
            }
        }
    },
    new
    function() {
        function t(t, e, n, i, r, s, a, o) {
            var h = new I(n, i, r, s, a, o); (!e || e(h)) && t.push(h)
        }
        function e(r, s, a, o, h, u, l, c, d, f, _, g, v) {
            if (! (v > 20)) {
                ...
                I = M(x, b, C, S, s[2], s[3]) || 0,
                A = M(x, b, C, S, s[4], s[5]) || 0,
                T = I * A > 0 ? .75: 4 / 9,
                O = T * Math.min(0, I, A),
                L = T * Math.max(0, I, A),
                E = M(x, b, C, S, r[0], r[1]),
                ...
                w = 0;
                    ...
                    V = F[0],
                    q = F[1];
                    if (B = i(V, q, O, L), V.reverse(), q.reverse(), R = i(V, q, O, L), null == B || null == R) return ! 1;
                    r = z.getPart(r, B, R),
                    w = R - B,
                    m = c * B + l * (1 - B),
                    y = c * R + l * (1 - R)
                }
                if (_ > .8 && w > .8) if (y - m > f - d) {
                    var Z = z.subdivide(r, .5),
                    H = m + (y - m) / 2;
                    e(s, Z[0], o, a, h, u, d, f, m, H, w, !g, ++v),
                    e(s, Z[1], o, a, h, u, d, f, H, y, w, !g, v)
                } else {
                    var Z = z.subdivide(s, .5),
                    H = d + (f - d) / 2;
                    e(Z[0], r, o, a, h, u, d, H, m, y, w, !g, ++v),
                    e(Z[1], r, o, a, h, u, H, f, m, y, w, !g, v)
                } else if (Math.max(f - d, y - m) < P) {
                    var U = m + (y - m) / 2,
                    W = d + (f - d) / 2;
                    g ? t(h, u, o, W, z.evaluate(s, W, 0), a, U, z.evaluate(r, U, 0)) : t(h, u, a, U, z.evaluate(r, U, 0), o, W, z.evaluate(s, W, 0))
        ...
        function n(t, e, n, i) {
            ...
            c = u(0, t, 1, i, 2 / 3, n),
            d = !1;
            if (0 > l * c) r = [[s, a, h], [s, o, h]],
            d = 0 > l;
            else {
                var f,
                _ = 0,
                g = 0 === l || 0 === c;
                Math.abs(l) > Math.abs(c) ? (f = a, _ = (i - n - (i - t) / 3) * (2 * (i - n) - i + e) / 3) : (f = o, _ = (e - t + (t - i) / 3) * ( - 2 * (t - e) + t - n) / 3),
                r = 0 > _ || g ? [[s, f, h], [s, h]] : [[s, a, o, h], [s, h]],
                d = l ? 0 > l: 0 > c
            }
            return d ? r.reverse() : r
        }
        function i(t, e, n, i) {
            for (var r, s, a, o, h, u = null, l = 0, c = e.length - 1; c > l; l++) {
        ...
        function r(e, n, i, r, s, a) {
            for (var o = z.isLinear(e), h = o ? n: e, u = o ? e: n, l = u[0], c = u[1], d = u[6], f = u[7], _ = d - l, g = f - c, p = Math.atan2( - g, _), v = Math.sin(p), m = Math.cos(p), y = _ * m - g * v, w = [0, 0, 0, 0, y, 0, y, 0], x = [], b = 0; 8 > b; b += 2) {
                var C = h[b] - l,
                S = h[b + 1] - c;
                x.push(C * m - S * v, S * m + C * v)
            }
            for (var P = [], k = z.solveCubic(x, 1, 0, P, 0, 1), b = 0; k > b; b++) {
                var M = P[b],
                C = z.evaluate(x, M, 0).x;
                if (C >= 0 && y >= C) {
                    var I = z.getParameterOf(w, C, 0),
                    A = o ? I: M,
                    T = o ? M: I;
                    t(s, a, i, A, z.evaluate(e, A, 0), r, T, z.evaluate(n, T, 0))
                }
            }
        }
        function s(e, n, i, r, s, a) {
            ...
            if (o) {
                var h = o.x,
                u = o.y;
                t(s, a, i, z.getParameterOf(e, h, u), o, r, z.getParameterOf(n, h, u), o)
            }
        }
        return {
            statics: {
                getIntersections: function(t, n, i, a, o, h) {
                    var u = z.isLinear(t),
                    l = z.isLinear(n);
                    return (u && l ? s: u || l ? r: e)(t, n, i, a, o, h, 0, 1, 0, 1, 0, !1, 0),
                    o
                }
            }
        }
    ...
    I = e.extend({
        ...
        getCurve: function(t) {
            return (!this._curve || t) && (this._curve = this._segment1.getCurve(), null == this._curve.getParameterOf(this._point) && (this._curve = this._segment2.getPrevious().getCurve())),
            this._curve
        },
        getIntersection: function() {
            ...
            if (!t && this._curve2) {
                ...
                this._intersection = t = new I(this._curve2, e, this._point2 || this._point, this),
        ...
        getTangent: function() {
            ...
            e = this.getCurve();
            return null != t && e && e.getTangentAt(t, !0)
        },
        getNormal: function() {
            var t = this.getParameter(),
            e = this.getCurve();
            return null != t && e && e.getNormalAt(t, !0)
        },
        getDistance: function() {
        ...
        toString: function() {
            ...
            return null != r && t.push("parameter: " + n.number(r)),
            null != this._distance && t.push("distance: " + n.number(this._distance)),
            "{ " + t.join(", ") + " }"
        }
    }),
    A = y.extend({
        ...
        getIntersections: function(e, n) {
            ...
            if (this === e && (e = null), e && !this.getBounds().touches(e.getBounds())) return [];
            for (var r = [], s = this.getCurves(), a = e ? e.getCurves() : s, o = this._matrix.orNullIfIdentity(), h = e ? e._matrix.orNullIfIdentity() : o, u = s.length, l = e ? a.length: u, c = [], d = 1e - 11, f = 1 - 1e - 11, _ = 0; l > _; _++) c[_] = a[_].getValues(h);
            for (var _ = 0; u > _; _++) {
                var g = s[_],
                ...
                if (!e) {
                    ...
                    if (new p(m._point.subtract(w), w.multiply(2), !0).intersect(new p(y._point.subtract(x), x.multiply(2), !0), !1)) {
                        var b = z.subdivide(v);
                        z.getIntersections(b[0], b[1], g, g, r, 
                        function(e) {
                            return e._parameter <= f ? (e._parameter /= 2, e._parameter2 = .5 + e._parameter2 / 2, !0) : t
                        })
                    }
                }
                for (var C = e ? 0: _ + 1; l > C; C++) z.getIntersections(v, c[C], g, a[C], r, !e && (C === _ + 1 || C === l - 1 && 0 === _) && 
                function(t) {
                    var e = t._parameter;
                    return e >= d && f >= e
                })
            ...
            for (var S = r.length - 1, _ = S; _ >= 0; _--) {
                ...
                k = P._curve.getNext(),
                M = P._curve2.getNext();
                k && P._parameter >= f && (P._parameter = 0, P._curve = k),
                M && P._parameter2 >= f && (P._parameter2 = 0, P._curve2 = M)
            }
            if (S > 0) {
                r.sort(i);
                for (var _ = S; _ >= 0; _--) r[_].equals(r[0 === _ ? S: _ - 1]) && (r.splice(_, 1), S--)
            }
            if (n) {
        ...
        setPathData: function(t) {
            ...
            for (var d = 0, f = a.length; f > d; d++) {
                ...
                case "h":
                case "v":
                    for (var w = "h" === p ? "x": "y", y = 0; v > y; y++) u[w] = e(y, w),
                    this.lineTo(u);
                    s = u;
                    break;
                case "c":
                ...
                case "t":
                    ...
                    break;
                case "a":
                    for (var y = 0; v > y; y += 7) this.arcTo(u = n(y + 5), new c( + i[0], +i[1]), +i[2], +i[4], +i[3]);
                    break;
                case "z":
                    this.closePath(!0)
                }
    ...
    T = A.extend({
        ...
        initialize: function(e) {
            ...
            n && n.length > 0 ? this.setSegments(n) : (this._curves = t, this._selectedSegmentState = 0, n || "string" != typeof e || (this.setPathData(e), e = null)),
        ...
        clone: function(e) {
            var n = new T(y.NO_INSERT);
            return n.setSegments(this._segments),
            n._closed = this._closed,
            this._clockwise !== t && (n._clockwise = this._clockwise),
            this._clone(n, e)
        },
        ...
        getStyle: function() {
            var t = this._parent;
            return (t instanceof O ? t: this)._style
        },
    ...
    },
    {
        ...
        getPathData: function(t) {
            function e(e, n, s) {
                ...
                h = e._handleOut,
                u = n._handleIn;
                if (h.isZero() && u.isZero()) s || r.push("L" + i.point(o, t));
                else {
                    var l = o.subtract(a);
                    r.push("c" + i.point(h, t) + " " + i.point(l.add(u), t) + " " + i.point(l, t))
                }
            }
            ...
            r.push("M" + i.point(n[0]._point));
            for (var s = 0, o = n.length - 1; o > s; s++) e(n[s], n[s + 1], !1);
            return this._closed && (e(n[n.length - 1], n[0], !0), r.push("z")),
            r.join("")
        }
    },
    {
        ...
        _add: function(t, e) {
            for (var n = this._segments, i = this._curves, r = t.length, s = null == e, e = s ? n.length: e, a = 0; r > a; a++) {
                ...
                o._path = this,
                o._index = e + a,
                o._selectionState && this._updateSelection(o, 0, o._selectionState)
            }
            ...
            if (i || t._curves) {
                ...
                for (var a = l; c > a; a++) i.splice(a, 0, new z(this, null, null));
        ...
        _adjustCurves: function(t, e) {
            for (var n, i = this._segments, r = this._curves, s = t; e > s; s++) n = r[s],
            n._path = this,
            n._segment1 = i[s],
            n._segment2 = i[s + 1] || i[0]; (n = r[this._closed && 0 === t ? i.length - 1: t - 1]) && (n._segment2 = i[t] || i[0]),
            (n = r[e]) && (n._segment1 = i[e])
        },
        ...
        removeSegments: function(t, n, i) {
            t = t || 0,
            n = e.pick(n, this._segments.length);
            ...
            for (var u = 0; h > u; u++) {
                var l = o[u];
                l._selectionState && this._updateSelection(l, l._selectionState, 0),
                l._index = l._path = null
            }
            for (var u = t, c = r.length; c > u; u++) r[u]._index = u;
            if (s) {
                var d = t > 0 && n === a + (this._closed ? 1: 0) ? t - 1: t,
                s = s.splice(d, h);
                i && (o._curves = s.slice(1)),
                this._adjustCurves(d, d)
            }
            return this._changed(25),
            o
        },
        ...
        flatten: function(t) {
            for (var e = new L(this), n = 0, i = e.length / Math.ceil(e.length / t), r = e.length + (this._closed ? -i: i) / 2, s = []; r >= n;) s.push(new k(e.evaluate(n, 0))),
            n += i;
            this.setSegments(s)
        },
        reduce: function() {
        ...
        split: function(t, e) {
            if (null !== e) {
                ...
                if (t >= 0 && t < r.length) {
                    e > i && r[t++].divide(e, !0);
                    var s,
                    a = this.removeSegments(t, this._segments.length, !0);
                    return this._closed ? (this.setClosed(!1), s = this) : t > 0 && (s = this._clone((new T).insertAbove(this, !0))),
                    s._add(a, 0),
                    this.addSegment(a[0]),
                    s
                }
        ...
        isClockwise: function() {
            return this._clockwise !== t ? this._clockwise: T.isClockwise(this._segments)
        },
        ...
        reverse: function() {
            ...
            this._curves = null,
            this._clockwise !== t && (this._clockwise = !this._clockwise)
        },
        join: function(t) {
            if (t) {
                var e = t._segments,
                ...
                var r,
                s = t.getFirstSegment();
                n._point.equals(s._point) ? (n.setHandleOut(s._handleOut), this._add(e.slice(1))) : (r = this.getFirstSegment(), r._point.equals(s._point) && t.reverse(), i = t.getLastSegment(), r._point.equals(i._point) ? (r.setHandleIn(i._handleIn), this._add(e.slice(0, e.length - 1), 0)) : this._add(e.slice())),
                t.closed && this._add([e[0]]),
                t.remove()
            }
            var a = this.getFirstSegment(),
            o = this.getLastSegment();
            a !== o && a._point.equals(o._point) && (a.setHandleIn(o._handleIn), o.remove(), this.setClosed(!0))
        },
        getLength: function() {
        ...
        _getOffset: function(t) {
            ...
            if (null != e) {
                ...
                var s = n[e],
                a = t.getParameter();
                return a > 0 && (i += s.getPartLength(0, a)),
                i
            }
            return null
        },
        ...
        getLocationAt: function(t, e) {
            ...
            return t <= this.getLength() ? new I(n[n.length - 1], 1) : null
        },
        ...
        toShape: function(e) {
            ...
            l,
            d = this._segments;
            if (this.isPolygon() && 4 === d.length && n(0, 2) && n(1, 3) && i(1) ? (a = b.Rectangle, h = new c(s(0, 3), s(0, 1)), l = d[1]._point.add(d[2]._point).divide(2)) : 8 === d.length && r(0) && r(2) && r(4) && r(6) && n(1, 5) && n(3, 7) ? (a = b.Rectangle, h = new c(s(1, 6), s(0, 3)), u = h.subtract(new c(s(0, 7), s(1, 2))).divide(2), l = d[3]._point.add(d[4]._point).divide(2)) : 4 === d.length && r(0) && r(1) && r(2) && r(3) && (o.isZero(s(0, 2) - s(1, 3)) ? (a = b.Circle, u = s(0, 2) / 2) : (a = b.Ellipse, u = new c(s(2, 0) / 2, s(3, 1) / 2)), l = d[1]._point), a) {
                ...
                return _.rotate(l.subtract(f).getAngle() + 90),
        ...
        _hitTest: function(t, e) {
            ...
            function i(t, i, r) {
                if (!e.selected || i.isSelected()) {
                    var s = t._point;
                    if (i !== s && (i = i.add(s)), n(i, w)) return new P(r, _, {
                        segment: t,
                        point: i
                    })
                }
            ...
            function a(e) {
                if (("round" !== o || "round" !== u) && (c = new T({
                    internal: !0,
                    closed: !0
                }), m || e._index > 0 && e._index < v - 1 ? "round" !== o && (e._handleIn.isZero() || e._handleOut.isZero()) && T._addBevelJoin(e, o, C, l, s, !0) : "round" !== u && T._addSquareCap(e, u, C, s, !0), !c.isEmpty())) {
                    var i;
            ...
            b = e.fill && g.hasFill(),
            C = x ? g.getStrokeWidth() / 2: b ? 0: null;
            if (null != C && (C > 0 ? (o = g.getStrokeJoin(), u = g.getStrokeCap(), l = C * g.getMiterLimit(), w = y.add(new h(C, C))) : o = u = "round"), !e.ends || e.segments || m) {
                if (e.segments || e.handles) for (var S = 0; v > S; S++) if (f = r(p[S])) return f
            ...
            if (null != C) {
                ...
                if (!d && "miter" === o && v > 1) for (var S = 0; v > S; S++) {
                    var M = p[S];
                    if (t.getDistance(M._point) <= l && a(M)) {
                        d = M.getLocation();
                        break
                    }
                }
            }
            return ! d && b && this._contains(t) || d && !x ? new P("fill", this) : d ? new P("stroke", this, {
                location: d,
                point: d.getPoint()
            }) : null
        }
    ...
    function() {
        function t(t, e, n, i) {
            function r(e) {
                var n = a[e],
                i = a[e + 1]; (c != n || d != i) && (t.beginPath(), t.moveTo(c, d), t.lineTo(n, i), t.stroke(), t.beginPath(), t.arc(n, i, s, 0, 2 * Math.PI, !0), t.fill())
            }
        ...
        function e(t, e, n) {
            function i(e) {
                var i = d[e];
                if (n) i._transformCoordinates(n, _, !1),
                r = _[0],
                s = _[1];
                else {
                    var f = i._point;
            ...
            for (var r, s, a, o, h, u, l, c, d = e._segments, f = d.length, _ = Array(6), g = !0, p = 0; f > p; p++) i(p);
            e._closed && f > 0 && i(0)
        }
        return {
            _draw: function(t, n) {
                ...
                var r = n.dontStart,
                s = n.dontFinish || n.clip;
                r || t.beginPath();
                var a = this.getStyle(),
                o = a.hasFill(),
                h = a.hasStroke(),
                u = a.getDashArray(),
                l = !paper.support.nativeDash && h && u && u.length;
                if (!r && this._currentPath ? t.currentPath = this._currentPath: (o || h && !l || s) && (e(t, this), this._closed && t.closePath(), r || (this._currentPath = t.currentPath)), !s && (o || h) && (this._setStyles(t), o && (t.fill(a.getWindingRule()), t.shadowColor = "rgba(0,0,0,0)"), h)) {
                    if (l) {
                        r || t.beginPath();
                        var c,
                        d = new L(this),
                        ...
                        _ = -a.getDashOffset(),
                        g = 0;
                        for (_ %= f; _ > 0;) _ -= i(g--) + i(g--);
                        for (; f > _;) c = _ + i(g++),
                        (_ > 0 || c > 0) && d.drawPart(t, Math.max(_, 0), Math.max(c, 0)),
                        _ = c + i(g++)
                    }
                    t.stroke()
                }
        ...
        return {
            smooth: function() {
                ...
                if (! (2 >= n)) {
                    ...
                    if (i) for (var o = 0; s > o; o++) a[o] = e[o + n - s]._point,
                    a[o + n + s] = e[o]._point;
                    else r--;
                    ...
                    for (var v = null, o = s; r - s >= o; o++) {
                        ...
                        r > o && (m.setHandleOut(new h(l[o], c[o]).subtract(m._point)), v = r - 1 > o ? new h(2 * a[o + 1]._x - l[o + 1], 2 * a[o + 1]._y - c[o + 1]) : new h((a[r]._x + l[r - 1]) / 2, (a[r]._y + c[r - 1]) / 2))
                    }
                    if (i && v) {
    ...
    function() {
        ...
        return {
            ...
            curveTo: function() {
                ...
                s = 1 - r,
                a = t(this)._point,
                o = n.subtract(a.multiply(s * s)).subtract(i.multiply(r * r)).divide(2 * r * s);
            ...
            arcTo: function() {
                ...
                d = e.peek(arguments),
                f = e.pick(d, !0);
                if ("boolean" == typeof f) var _ = u.add(l).divide(2),
                n = _.add(_.subtract(u).rotate(f ? -90: 90));
                else if (e.remain(arguments) <= 2) n = l,
                l = h.read(arguments);
                else {
                    ...
                    T = b * b,
                    O = Math.sqrt(A / z + T / I);
                    if (O > 1 && (P *= O, M *= O, z = P * P, I = M * M), O = (z * I - z * T - I * A) / (z * T + I * A), C(O) < S && (O = 0), 0 > O) throw Error("Cannot create an arc with the given arguments");
                    i = new h(P * b / M, -M * x / P).multiply((y === f ? -1: 1) * Math.sqrt(O)).rotate(m).add(_),
                    a = (new g).translate(i).rotate(m).scale(P, M),
                    s = a._inverseTransform(u),
                    r = s.getDirectedAngle(a._inverseTransform(l)),
                    !f && r > 0 ? r -= 360: f && 0 > r && (r += 360)
                }
                if (n) {
                    var L = new p(u.add(n).divide(2), n.subtract(u).rotate(90), !0),
                    E = new p(n.add(l).divide(2), l.subtract(n).rotate(90), !0),
                    N = new p(u, l),
                    j = N.getSide(n);
                    ...
                    var D = N.getSide(i);
                    0 === D ? r = j * Math.abs(r) : j === D && (r += 0 > r ? 360: -360)
                }
                for (var B = Math.abs(r), R = B >= 360 ? 4: Math.ceil(B / 90), F = r / R, V = F * Math.PI / 360, q = 4 / 3 * Math.sin(V) / (1 + Math.cos(V)), Z = [], H = 0; R >= H; H++) {
                    var w = l,
                    U = null;
                    if (R > H && (U = s.rotate(90).multiply(q), a ? (w = a._transformPoint(s), U = a._transformPoint(s.add(U)).subtract(w)) : w = i.add(s)), 0 === H) o.setHandleOut(U);
                    else {
                        var W = s.rotate( - 90).multiply(q);
                        a && (W = a._transformPoint(s.add(W)).subtract(w)),
                        Z.push(new k(w, W, U))
                    }
                    s = s.rotate(F)
                }
    ...
    {
        _getBounds: function(t, e) {
            return T[t](this._segments, this._closed, this.getStyle(), e)
        },
        statics: {
            isClockwise: function(t) {
                for (var e = 0, n = 0, i = t.length; i > n; n++) for (var r = z.getValues(t[n], t[i > n + 1 ? n + 1: 0]), s = 2; 8 > s; s += 2) e += (r[s - 2] - r[s]) * (r[s + 1] + r[s - 1]);
                return e > 0
            },
            getBounds: function(t, e, n, i, r) {
                function s(t) {
                    t._transformCoordinates(i, o, !1);
                    for (var e = 0; 2 > e; e++) z._addBounds(h[e], h[e + 4], o[e + 2], o[e], e, r ? r[e] : 0, u, l, c);
                    var n = h;
                    h = o,
                    o = n
                }
            ...
            getStrokeBounds: function(t, e, n, i) {
                ...
                function a(t, e) {
                    var n = t._handleIn,
                    i = t._handleOut;
                    "round" === e || !n.isZero() && !i.isZero() && n.isColinear(i) ? s(t) : T._addBevelJoin(t, e, u, p, r)
                }
                function o(t, e) {
                    "round" === e ? s(t) : T._addSquareCap(t, e, u, r)
                }
                if (!n.hasStroke()) return T.getBounds(t, e, n, i);
                for (var h = t.length - (e ? 0: 1), u = n.getStrokeWidth() / 2, l = T._getPenPadding(u, i), d = T.getBounds(t, e, n, i, l), _ = n.getStrokeJoin(), g = n.getStrokeCap(), p = u * n.getMiterLimit(), v = new f(new c(l).multiply(2)), m = 1; h > m; m++) a(t[m], _);
                return e ? a(t[0], _) : h > 0 && (o(t[0], g), o(t[t.length - 1], g)),
                d
            },
            ...
            _addSquareCap: function(t, e, n, i, r) {
                ...
                "square" === e && (s = s.add(o.rotate(0 == a.getParameter() ? -90: 90))),
                i(s.add(o)),
                i(s.subtract(o))
            },
            ...
            getRoughBounds: function(t, e, n, i) {
                ...
                T.getHandleBounds(t, e, n, i, T._getPenPadding(r, i), T._getPenPadding(s, i))
            }
        }
    });
    T.inject({
        ...
        function() {
            function t(t, n, i) {
                var r = e.getNamed(i),
                s = new T(r && r.insert === !1 && y.NO_INSERT);
                return s._add(t),
                s._closed = n,
                s.set(r)
            }
            function n(e, n, i) {
                for (var s = Array(4), a = 0; 4 > a; a++) {
                    var o = r[a];
                    s[a] = new k(o._point.multiply(n).add(e), o._handleIn.multiply(n), o._handleOut.multiply(n))
                }
                return t(s, !0, i)
            }
            ...
            return {
                Line: function() {
                    return t([new k(h.readNamed(arguments, "from")), new k(h.readNamed(arguments, "to"))], !1, arguments)
                },
                Circle: function() {
                ...
                Rectangle: function() {
                    ...
                    if (!r || r.isZero()) e = [new k(s), new k(a), new k(o), new k(h)];
                    else {
                        ...
                        d = u * i,
                        _ = l * i;
                        e = [new k(s.add(u, 0), null, [ - d, 0]), new k(s.subtract(0, l), [0, _]), new k(a.add(0, l), null, [0, -_]), new k(a.add(u, 0), [ - d, 0], null), new k(o.subtract(u, 0), null, [d, 0]), new k(o.add(0, l), [0, -_], null), new k(h.subtract(0, l), null, [0, _]), new k(h.subtract(u, 0), [d, 0])]
                    }
                ...
                RegularPolygon: function() {
                    for (var n = h.readNamed(arguments, "center"), i = e.readNamed(arguments, "sides"), r = e.readNamed(arguments, "radius"), s = 360 / i, a = !(i % 3), o = new h(0, a ? -r: r), u = a ? -1: .5, l = Array(i), c = 0; i > c; c++) l[c] = new k(n.add(o.rotate((c + u) * s)));
                    return t(l, !0, arguments)
                },
                Star: function() {
                    for (var n = h.readNamed(arguments, "center"), i = 2 * e.readNamed(arguments, "points"), r = e.readNamed(arguments, "radius1"), s = e.readNamed(arguments, "radius2"), a = 360 / i, o = new h(0, -1), u = Array(i), l = 0; i > l; l++) u[l] = new k(n.add(o.rotate(a * l).multiply(l % 2 ? s: r)));
    ...
    },
    {
        beans: !0,
        getPathData: function(t) {
            for (var e = this._children, n = [], i = 0, r = e.length; r > i; i++) n.push(e[i].getPathData(t));
            return n.join(" ")
        }
    },
    {
        _getChildHitTestOptions: function(t) {
            return "path" === t.type ? t: new e(t, {
                fill: !1
            })
        },
        _draw: function(t, e) {
            ...
            if (0 !== n.length) {
                if (this._currentPath) t.currentPath = this._currentPath;
                    ...
                    t.beginPath();
                    for (var i = 0, r = n.length; r > i; i++) n[i].draw(t, e);
                    this._currentPath = t.currentPath
                }
                if (!e.clip) {
                    this._setStyles(t);
                    var s = this._style;
                    s.hasFill() && (t.fill(s.getWindingRule()), t.shadowColor = "rgba(0,0,0,0)"),
                    s.hasStroke() && t.stroke()
                }
            }
        },
        _drawSelected: function(t, e) {
            for (var n = this._children, i = 0, r = n.length; r > i; i++) {
                var s = n[i],
                a = s._matrix;
                s._drawSelected(t, a.isIdentity() ? e: e.clone().concatenate(s._matrix))
            }
        }
    },
    new
    function() {
        ...
        return e.each(["lineTo", "cubicCurveTo", "quadraticCurveTo", "curveTo", "arcTo", "lineBy", "cubicCurveBy", "quadraticCurveBy", "curveBy", "arcBy"], 
        function(e) {
            n[e] = function() {
                var n = t(this, !0);
    ...
    function() {
            ...
            for (var p = 0, v = _.length; v > p; p++) {
                ...
                if (null == m._winding) {
                    ...
                    for (var x = 0; 3 > x; x++) {
                        ...
                        M = P.isHorizontal(),
                        z = P._path;
                        z._parent instanceof O && (z = z._parent),
                        d[x] = a && l && (z === u && l._getWinding(k, M) || z === l && !u._getWinding(k, M)) ? 0: n(k, g, M)
                    }
                    d.sort();
                    for (var I = d[1], x = c.length - 1; x >= 0; x--) c[x]._winding = I
                }
            }
            var A = new O;
            return A.addChildren(i(_, s), !0),
            u.remove(),
            l && l.remove(),
            A.reduce()
        }
        function e(t) {
            ...
            for (var n, i, r, s = 1e - 5, a = t.length - 1; a >= 0; a--) {
                var o = t[a],
                h = o._parameter;
                r && r._curve === o._curve && r._parameter > 0 ? h /= r._parameter: (n && e(), i = o._curve, n = i.isLinear() && []);
                var u,
                l; (u = i.divide(h, !0, !0)) ? (l = u._segment1, i = u.getPrevious()) : l = s > h ? i._segment1: h > 1 - s ? i._segment2: i.getPartLength(0, h) < i.getPartLength(h, 1) ? i._segment1: i._segment2,
        ...
        function n(t, e, i, r) {
            ...
            f = 1 - s;
            if (i) {
                for (var _ = -1 / 0, g = 1 / 0, p = o - s, v = o + s, m = 0, y = e.length; y > m; m++) {
                    var w = e[m].values;
                    if (z.solveCubic(w, 0, a, c, 0, 1) > 0) for (var x = c.length - 1; x >= 0; x--) {
                        var b = z.evaluate(w, c[x], 0).y;
                        p > b && b > _ ? _ = b: b > v && g > b && (g = b)
                    }
                }
                _ = (_ + o) / 2,
                g = (g + o) / 2,
            ...
            } else for (var C = a - s, S = a + s, m = 0, y = e.length; y > m; m++) {
                var P = e[m],
                w = P.values,
                k = P.winding,
                M = P.next;
                if (k && (1 === k && o >= w[1] && o <= w[7] || o >= w[7] && o <= w[1]) && 1 === z.solveCubic(w, 1, o, c, 0, M.winding || M.values[1] !== o ? f: 1)) {
                    var I = c[0],
                    A = z.evaluate(w, I, 0).x,
                    T = z.evaluate(w, I, 1).y;
                    d(T) < s && !z.isLinear(w) || s > I && T * z.evaluate(P.previous.values, I, 1).y < 0 ? r && A >= C && S >= A && (++u, ++l) : C >= A ? u += k: A >= S && (l += k)
                }
            }
        ...
        function i(t, e, n) {
            ...
            for (var i, r, s = [], a = .001, o = .999, h = 0, u = t.length; u > h; h++) if (i = r = t[h], !i._visited && e(i._winding)) {
                var l = new T(y.NO_INSERT),
                c = i._intersection,
                d = c && c._segment,
                f = !1,
                _ = 1;
                do {
                    ...
                    if (f && (!e(i._winding) || n) && (c = i._intersection) && (g = c._segment) && g !== r) {
                        ...
                        _ = 1;
                            ...
                            if (0 !== P * M) {
                                var z = M > P ? b: x,
                                I = e(z._segment1._winding) ? z: M > P ? x: b,
                                A = I._segment1;
                                _ = I === b ? -1: 1,
                                A._visited && i._path !== A._path || !e(A._winding) ? _ = 1: (i._visited = g._visited, i = g, A._visited && (_ = 1))
                            } else _ = 1
                        }
                        v = _ > 0 ? i._handleOut: i._handleIn
                    }
                ...
                while (i && !i._visited && i !== r && i !== d && (i._intersection || e(i._winding))); ! i || i !== r && i !== d ? l.lastSegment._handleOut.set(0, 0) : (l.firstSegment.setHandleIn((i === d ? d: i)._handleIn), l.setClosed(!0)),
                l._segments.length > (l._closed ? l.isPolygon() ? 2: 0: 1) && s.push(l)
            }
            return s
        }
        return {
                ...
                if (0 !== z.getLength(e)) {
                    ...
                    if (z.isLinear(e)) t(e);
                        ...
                        if (0 === d) t(e);
                            ...
                            _ = z.subdivide(e, f);
                            t(_[0]),
                            d > 1 && (f = (c[1] - f) / (1 - f), _ = z.subdivide(_[1], f), t(_[0])),
                            t(_[1])
                        }
                    }
                }
        ...
        getInteriorPoint: function() {
            ...
            if (!this.contains(e)) {
                for (var n = this._getMonoCurves(), i = [], r = e.y, s = [], a = 0, o = n.length; o > a; a++) {
                    var h = n[a].values;
                    if ((1 === n[a].winding && r >= h[1] && r <= h[7] || r >= h[7] && r <= h[1]) && z.solveCubic(h, 1, r, i, 0, 1) > 0) for (var u = i.length - 1; u >= 0; u--) s.push(z.evaluate(h, i[u], 0).x);
                    if (s.length > 1) break
                }
                e.x = (s[0] + s[1]) / 2
            }
    ...
    var L = e.extend({
        initialize: function(t) {
            function e(t, e) {
                var n = z.getValues(t, e);
                s.curves.push(n),
                s._computeParts(n, t._index, 0, 1)
            }
            this.curves = [],
            this.parts = [],
            this.length = 0,
            this.index = 0;
            for (var n, i = t._segments, r = i[0], s = this, a = 1, o = i.length; o > a; a++) n = i[a],
            e(r, n),
            r = n;
            t._closed && e(n, i[0])
        },
        _computeParts: function(t, e, n, i) {
            if (i - n > 1 / 32 && !z.isFlatEnough(t, .25)) {
                var r = z.subdivide(t),
                s = (n + i) / 2;
                ...
                o = t[7] - t[1],
                h = Math.sqrt(a * a + o * o);
                h > 1e - 5 && (this.length += h, this.parts.push({
                    offset: this.length,
                    value: i,
                    index: e
                }))
    ...
    E = e.extend({
        ...
        fit: function() {
            var t = this.points,
            e = t.length;
            return this.segments = e > 0 ? [new k(t[0])] : [],
            e > 1 && this.fitCubic(0, e - 1, t[1].subtract(t[0]).normalize(), t[e - 2].subtract(t[e - 1]).normalize()),
            this.segments
        },
        fitCubic: function(e, n, i, r) {
            if (1 == n - e) {
                ...
                a = this.points[n],
                o = s.getDistance(a) / 3;
                return this.addCurve([s, s.add(i.normalize(o)), a.add(r.normalize(o)), a]),
                t
            }
        ...
        generateBezier: function(t, e, n, i, r) {
            for (var s = 1e - 11, a = this.points[t], o = this.points[e], h = [[0, 0], [0, 0]], u = [0, 0], l = 0, c = e - t + 1; c > l; l++) {
                var d = n[l],
                f = 1 - d,
                _ = 3 * d * f,
                g = f * f * f,
                ...
                y = i.normalize(p),
                w = r.normalize(v),
                x = this.points[t + l].subtract(a.multiply(g + p)).subtract(o.multiply(v + m));
                h[0][0] += y.dot(y),
                h[0][1] += y.dot(w),
                h[1][0] = h[0][1],
                h[1][1] += w.dot(w),
            ...
            if (Math.abs(S) > s) {
                ...
                var M = h[0][0] + h[0][1],
                z = h[1][0] + h[1][1];
                b = C = Math.abs(M) > s ? u[0] / M: Math.abs(z) > s ? u[1] / z: 0
            }
            var I = o.getDistance(a);
            return s *= I,
            (s > b || s > C) && (b = C = I / 3),
    ...
    N = y.extend({
        ...
        _clone: function be(t) {
            return t.setContent(this._content),
            be.base.call(this, t)
        },
        getContent: function() {
        ...
        _draw: function(t) {
            if (this._content) {
                ...
                for (var s = 0, a = n.length; a > s; s++) {
                    t.shadowColor = r;
                    var o = n[s];
                    e.hasFill() && (t.fillText(o, 0, 0), t.shadowColor = "rgba(0,0,0,0)"),
    ...
    function() {
        function t(t) {
            ...
            if (i) {
                ...
                var h = s[t];
                if (!h) {
                    n || (n = Q.getContext(1, 1), n.globalCompositeOperation = "copy"),
        ...
        r = {},
        s = {},
        o = [[0, 3, 1], [2, 0, 1], [1, 0, 3], [1, 2, 0], [3, 1, 0], [0, 1, 2]],
        u = {
            "rgb-hsb": function(t, e, n) {
                var i = Math.max(t, e, n),
                r = Math.min(t, e, n),
                s = i - r,
                a = 0 === s ? 0: 60 * (i == t ? (e - n) / s + (n > e ? 6: 0) : i == e ? (n - t) / s + 2: (t - e) / s + 4);
            ...
            "rgb-hsl": function(t, e, n) {
                ...
                s = i - r,
                a = 0 === s,
                o = a ? 0: 60 * (i == t ? (e - n) / s + (n > e ? 6: 0) : i == e ? (n - t) / s + 2: (t - e) / s + 4),
                h = (i + r) / 2,
                u = a ? 0: .5 > h ? s / (i + r) : s / (2 - i - r);
                return [o, u, h]
            },
            "hsl-rgb": function(t, e, n) {
                ...
                for (var i = [t + 1 / 3, t, t - 1 / 3], r = .5 > n ? n * (1 + e) : n + e - n * e, s = 2 * n - r, a = [], o = 0; 3 > o; o++) {
                    ...
                    0 > h && (h += 1),
                    h > 1 && (h -= 1),
                    a[o] = 1 > 6 * h ? s + 6 * (r - s) * h: 1 > 2 * h ? r: 2 > 3 * h ? s + 6 * (r - s) * (2 / 3 - h) : s
                }
                return a
            },
        ...
        function(t, n) {
            ...
            function(t, s) {
                ...
                function(t) {
                    ...
                    return t = B.read(Array.isArray(t) ? t: arguments, 0, {
                        readNull: !0
                    }),
                    e !== t && (e && e._removeOwner(this), t && t._addOwner(this)),
                    t
                }: "gradient" === n ? 
                function() {
                ...
                this["set" + a] = function(t) {
                    this._type === n || o && /^hs[bl]$/.test(this._type) || (this._components = this._convert(n), this._properties = i[n], this._type = n),
                    t = u.call(this, t),
                    null != t && (this._components[s] = t, this._changed())
                }
            },
            this)
        },
        {
            ...
            initialize: function l(e) {
                ...
                if ("string" === d && e in i && (n = e, e = u[1], Array.isArray(e) ? (s = e, a = u[2]) : (this.__read && (c = 1), u = h.call(u, 1), d = typeof e)), !s) {
                    if (o = "number" === d ? u: "object" === d && null != e.length ? e: null) {
                        ...
                        var f = i[n].length;
                        a = o[f],
                        this.__read && (c += o === arguments ? f + (null != a ? 1: 0) : 1),
                        o.length > f && (o = h.call(o, 0, f))
                    } else if ("string" === d) n = "rgb",
                    s = t(e),
                    4 === s.length && (a = s[3], s.length--);
                    else if ("object" === d) if (e.constructor === l) {
                        if (n = e._type, s = e._components.slice(), a = e._alpha, "gradient" === n) for (var _ = 1, g = s.length; g > _; _++) {
                            var p = s[_];
                            p && (s[_] = p.clone())
                        }
                    } else if (e.constructor === B) n = "gradient",
                    o = u;
                    else {
            ...
            toString: function() {
                ...
                return null != this._alpha && e.push("alpha: " + i.number(this._alpha)),
                "{ " + e.join(", ") + " }"
            },
            toCSS: function(t) {
                function e(t) {
                ...
                return n = [e(n[0]), e(n[1]), e(n[2])],
                1 > i && n.push(0 > i ? 0: i),
                t ? "#" + ((1 << 24) + (n[0] << 16) + (n[1] << 8) + n[2]).toString(16).slice(1) : (4 == n.length ? "rgba(": "rgb(") + n.join(",") + ")"
            },
    ...
    R = e.extend({
        ...
        initialize: function(e, n) {
            if (e) {
                var i,
                r;
                n === t && Array.isArray(e) ? (i = e[0], r = e[1]) : e.color ? (i = e.color, r = e.rampPoint) : (i = e, r = n),
                this.setColor(i),
                this.setRampPoint(r)
            }
        },
    ...
    function() {
        ...
        function(n, a) {
            ...
            s[l] = function(e) {
                var n = this._owner,
                i = n && n._children;
                if (i && i.length > 0 && !(n instanceof O)) for (var r = 0, s = i.length; s > r; r++) i[r]._style[l](e);
                else {
                    var h = this._values[a];
                    h != e && (o && (h && (h._owner = t), e && e.constructor === D && (e._owner && (e = e.clone()), e._owner = n)), this._values[a] = e, n && n._changed(u || 65))
                }
            },
            s[c] = function(n) {
                var i,
                r = this._owner,
                s = r && r._children;
                if (!s || 0 === s.length || n || r instanceof O) {
                    var i = this._values[a];
                    return i === t ? (i = this._defaults[a], i && i.clone && (i = i.clone()), this._values[a] = i) : !o || i && i.constructor === D || (this._values[a] = i = D.read([i], 0, {
                        readNull: !0,
                        clone: !0
                    }), i && (i._owner = r)),
                    i
    ...
    },
    {
        ...
        initialize: function(t, e, n) {
            this._values = {},
            this._owner = e,
            this._project = e && e._project || n || paper.project,
        ...
        getLeading: function Se() {
            ...
            e = this.getFontSize();
            return /pt|em|%|px/.test(e) && (e = this.getView().getPixelSize(e)),
            null != t ? t: 1.2 * e
        }
    }),
    V = new
    function() {
        ...
        return {
            ...
            get: function(t, e) {
                return t ? r.test(e) ? "value" === e || "string" != typeof t[e] ? t[e] : !0: e in s ? t[s[e]] : t.getAttribute(e) : null
            },
            set: function(e, n, i) {
                if ("string" != typeof n) for (var a in n) n.hasOwnProperty(a) && this.set(e, a, n[a]);
                else {
                    if (!e || i === t) return e;
                    r.test(n) ? e[n] = i: n in s ? e[s[n]] = i: "style" === n ? this.setStyle(e, i) : "events" === n ? q.add(e, i) : e.setAttribute(n, i)
                }
                return e
            },
            ...
            setStyle: function(t, e, n) {
                if ("string" != typeof e) for (var i in e) e.hasOwnProperty(i) && this.setStyle(t, i, e[i]);
                else ! /^-?[\d\.]+$/.test(n) || e in a || (n += "px"),
                t.style[e] = n;
                return t
            },
            ...
            removeClass: function(t, e) {
                t.className = t.className.replace(RegExp("\\s*" + e + "\\s*"), " ").trim()
            },
            remove: function(t) {
            ...
            setPrefixed: function(t, e, n) {
                if ("object" == typeof e) for (var r in e) i(t, r, !0, e[r]);
                else i(t, e, !0, n)
            }
        }
    },
    ...
    q.requestAnimationFrame = new
    function() {
        function t() {
            for (var e = s.length - 1; e >= 0; e--) {
                var o = s[e],
                h = o[0],
                u = o[1]; (!u || ("true" == r.getAttribute(u, "keepalive") || a) && V.isInView(u)) && (s.splice(e, 1), h())
            }
            n && (s.length ? n(t) : i = !1)
        }
        var e,
        ...
        function(r, a) {
            s.push([r, a]),
            n ? i || (n(t), i = !0) : e || (e = setInterval(t, 1e3 / 60))
        }
    };
    var Z = e.extend(n, {
        _class: "View",
        initialize: function Pe(t, e) {
            ...
            this._element = e;
            var n;
            this._pixelRatio || (this._pixelRatio = window.devicePixelRatio || 1),
            this._id = e.getAttribute("id"),
            null == this._id && e.setAttribute("id", this._id = "view-" + Pe._id++),
            ...
            if (V.setPrefixed(e.style, {
                ...
                this._windowEvents = {
                    resize: function() {
                        V.isInvisible(e) || (s = V.getOffset(e, !0)),
                        a.setViewSize(V.getViewportBounds(e).getSize().subtract(s))
                    }
                },
        ...
        _animateItem: function(t, e) {
            ...
            1 === ++this._frameItemCount && this.attach("frame", this._handleFrameItems)) : (delete n[t._id], 0 === --this._frameItemCount && this.detach("frame", this._handleFrameItems))
        },
        _handleFrameItems: function(t) {
            for (var n in this._frameItems) {
                var i = this._frameItems[n];
                i.item.fire("frame", new e(t, {
                    time: i.time += t.delta,
                    count: i.count++
                }))
            }
        ...
        _update: function() {
            ...
            this._handlingFrame || (this._animate ? this._handleFrame() : this.update())
        },
        _changed: function(t) {
        ...
        setViewSize: function() {
            ...
            e.isZero() || (this._viewSize.set(t.width, t.height), this._setViewSize(t), this._bounds = null, this.fire("resize", {
                size: t,
                delta: e
            }), this._update())
        },
        ...
        getBounds: function() {
            return this._bounds || (this._bounds = this._matrix.inverted()._transformBounds(new f(new h, this._viewSize))),
            this._bounds
        },
        getSize: function() {
        ...
        setZoom: function(t) {
            this._transform((new g).scale(t / this._zoom, this.getCenter())),
            this._zoom = t
        },
        isVisible: function() {
    ...
    function() {
        ...
        function n() {
            if (!Z._focused || !Z._focused.isVisible()) for (var t = 0, e = Z._views.length; e > t; t++) {
                var n = Z._views[t];
                if (n && n.isVisible()) {
                    Z._focused = a = n;
                    break
        ...
        f = {
            mouseout: function(t) {
                var n = Z._focused,
                r = q.getRelatedTarget(t); ! n || r && "HTML" !== r.nodeName || i(n, e(n, t), t)
            },
            scroll: n
        };
        return d[o] = function(n) {
            ...
            (r = i._scope.tool) && r._handleEvent("mousedown", s, n),
            i.update()
        },
        f[h] = function(o) {
            var h = Z._focused;
            if (!l) {
                var u = t(o);
                u ? (h !== u && i(h, e(h, o), o), s = h, h = Z._focused = a = u) : a && a === h && (h = Z._focused = s, n())
            }
            if (h) {
                var c = e(h, o); (l || h.getBounds().contains(c)) && (r = i(h, c, o))
            }
        },
        f[u] = function(t) {
            var n = Z._focused;
    ...
    H = Z.extend({
        ...
        initialize: function(t, e) {
            if (! (e instanceof HTMLCanvasElement)) {
                ...
                if (n.isZero()) throw Error("Cannot create CanvasView with the provided argument: " + e);
                e = Q.getCanvas(n)
            }
            if (this._context = e.getContext("2d"), this._eventCounters = {},
            this._pixelRatio = 1, "off" !== r.getAttribute(e, "hidpi")) {
                var i = window.devicePixelRatio || 1,
                s = V.getPrefixed(this._context, "backingStorePixelRatio") || 1;
        ...
        _setViewSize: function(t) {
            ...
            r.width = e * i,
            r.height = n * i,
            1 !== i && (s.width = e + "px", s.height = n + "px", this._context.scale(i, i))
        },
        getPixelSize: function(t) {
            var e = this._context,
            n = e.font;
            return e.font = t + " serif",
            t = parseFloat(e.font),
            e.font = n,
            t
        },
        ...
        update: function() {
            ...
            var e = this._context,
            n = this._viewSize;
            return e.clearRect(0, 0, n.width + 1, n.height + 1),
    ...
    function() {
        function e(e, n, i, r, s, a) {
            function o(e) {
                return e.responds(n) && (h || (h = new $(n, i, r, s, a ? r.subtract(a) : null)), e.fire(n, h) && h.isStopped) ? (i.preventDefault(), !0) : t
            }
            for (var h, u = s; u;) {
                if (o(u)) return ! 0;
                u = u.getParent()
        ...
        return {
            _handleEvent: function(t, c, d) {
                if (this._eventCounters[t]) {
                    ...
                    case "mouseup":
                        p = e(this, t, d, c, g, n),
                        h && (i && !i.equals(c) && e(this, "mousedrag", d, c, h, i), g !== h && (r = c, e(this, "mousemove", d, c, g, r))),
                        !p && g && g === s && (l = Date.now(), e(this, u && s.responds("doubleclick") ? "doubleclick": "click", d, n, g), u = !1),
                        s = h = null;
                        break;
                    case "mousemove":
                        h && (p = e(this, "mousedrag", d, c, h, i)),
                        p || (g !== o && (r = c), p = e(this, t, d, c, g, r)),
                        i = r = c,
                        g !== o && (e(this, "mouseleave", d, c, o), o = g, e(this, "mouseenter", d, c, g))
                    }
                    return p
                }
            }
    ...
    function() {
        function t(t, n, r, h) {
            ...
            t ? a[n] = r: delete a[n],
            p && p.responds(f) && (paper = g, p.fire(f, new W(t, d, l, h)), _ && _.update())
        }
        var n,
        i = {
            8: "backspace",
    ...
    e.extend(n, {
        ...
        initialize: function(n, i, r) {
            var s = V.find(".palettejs-panel") || V.find("body").appendChild(V.create("div", {
                "class": "palettejs-panel"
            }));
            this._element = s.appendChild(V.create("table", {
            ...
            for (var a in this.components = i) {
                var o = i[a];
                o instanceof X || (null == o.value && (o.value = r[a]), o.name = a, o = i[a] = new X(o)),
                this._element.appendChild(o._element),
                o._palette = this,
                r[a] === t && (r[a] = o.value)
            }
            this.values = e.each(r, 
            function(t, n) {
                var s = i[n];
                s && e.define(r, n, {
                    enumerable: !0,
    ...
    var X = e.extend(n, {
        ...
        _types: {
            ...
            color: {
                ...
                setValue: function(t) {
                    return new D(t).toCSS("color" === V.get(this._input, "type"))
                }
            }
        },
        initialize: function ke(t) {
            this._id = ke._id = (ke._id || 0) + 1,
            this._type = t.type in this._types ? t.type: "options" in t ? "list": "onClick" in t ? "button": typeof t.value,
            ...
            this._input = V.create(this._meta.tag || "input", {
                ...
                events: {
                    change: function() {
                        n.setValue(V.get(this, n._meta.value || "value"))
                    },
                    click: function() {
                        n.fire("click")
                    }
            ...
            this.attach("change", 
            function(t) {
                this._dontFire || this._palette.fire("change", this, this.name, t)
            }),
            this._element = V.create("tr", ["td", [this._label = V.create("label", {
                "for": i
            })], "td", [this._input]]),
            e.each(t, 
            function(t, e) {
        ...
        setValue: function(t) {
            ...
            this._value !== t && (this._value = t, this._dontFire || this.fire("change", this.getValue()))
        },
        getRange: function() {
            return [parseFloat(V.get(this._input, "min")), parseFloat(V.get(this._input, "max"))]
        },
        ...
        getItem: function() {
            if (!this._item) {
                ...
                if (t) {
                    ...
                    /^(Group|CompoundPath)$/.test(n._class);) e = n,
                    n = n._parent;
                    this._item = e
                }
            }
    ...
    Y = s.extend({
        ...
        setMinDistance: function(t) {
            this._minDistance = t,
            null != this._minDistance && null != this._maxDistance && this._minDistance > this._maxDistance && (this._maxDistance = this._minDistance)
        },
        ...
        setMaxDistance: function(t) {
            this._maxDistance = t,
            null != this._minDistance && null != this._maxDistance && this._maxDistance < this._minDistance && (this._minDistance = t)
        },
        ...
        _updateEvent: function(t, e, n, i, r, s, a) {
            if (!r) {
                if (null != n || null != i) {
                    ...
                    if (o > u) return ! 1;
                    var l = null != i ? i: 0;
                    if (0 != l) if (u > l) e = this._point.add(h.normalize(l));
                    else if (a) return ! 1
                }
            ...
            return this._count = r ? 0: this._count + 1,
            !0
        },
        ...
        _handleEvent: function(t, e, n) {
            ...
            case "mousedown":
                ...
                break;
            case "mousedrag":
                for (var r = !1, s = !1; this._updateEvent(t, e, this.minDistance, this.maxDistance, !1, r, s);) i = this._fireEvent(t, n) || i,
                r = !0,
                s = !0;
                break;
            case "mouseup":
                !e.equals(this._point) && this._updateEvent("mousedrag", e, this.minDistance, this.maxDistance, !1, !1, !1) && (i = this._fireEvent("mousedrag", n)),
                this._updateEvent(t, e, null, this.maxDistance, !1, !1, !1),
    ...
    K = {
        request: function(t, e, n) {
            ...
            return i.open(t.toUpperCase(), e, !0),
    ...
    Q = {
        ...
        getCanvas: function(t, e, n) {
            var i,
            r = !0;
            "object" == typeof t && (n = e, e = t.height, t = t.width),
            n ? 1 !== n && (t *= n, e *= n) : n = 1,
            i = this.canvases.length ? this.canvases.pop() : document.createElement("canvas");
            var s = i.getContext("2d");
            return i.width === t && i.height === e ? r && s.clearRect(0, 0, t + 1, e + 1) : (i.width = t, i.height = e),
            s.save(),
            1 !== n && s.scale(n, n),
            i
        },
        getContext: function(t, e, n) {
            return this.getCanvas(t, e, n).getContext("2d")
        },
        release: function(t) {
    ...
    function() {
        ...
        y = {
            ...
            overlay: function() {
                f = 128 > u ? 2 * u * s / 255: 255 - 2 * (255 - u) * (255 - s) / 255,
                _ = 128 > l ? 2 * l * a / 255: 255 - 2 * (255 - l) * (255 - a) / 255,
                g = 128 > c ? 2 * c * o / 255: 255 - 2 * (255 - c) * (255 - o) / 255
            },
            "soft-light": function() {
                var t = s * u / 255;
                f = t + u * (255 - (255 - u) * (255 - s) / 255 - t) / 255,
                t = a * l / 255,
                _ = t + l * (255 - (255 - l) * (255 - a) / 255 - t) / 255,
                t = o * c / 255,
                g = t + c * (255 - (255 - c) * (255 - o) / 255 - t) / 255
            },
            "hard-light": function() {
                f = 128 > s ? 2 * s * u / 255: 255 - 2 * (255 - s) * (255 - u) / 255,
                _ = 128 > a ? 2 * a * l / 255: 255 - 2 * (255 - a) * (255 - l) / 255,
                g = 128 > o ? 2 * o * c / 255: 255 - 2 * (255 - o) * (255 - c) / 255
            },
            "color-dodge": function() {
                f = 0 === u ? 0: 255 === s ? 255: p(255, 255 * u / (255 - s)),
                _ = 0 === l ? 0: 255 === a ? 255: p(255, 255 * l / (255 - a)),
                g = 0 === c ? 0: 255 === o ? 255: p(255, 255 * c / (255 - o))
            },
            "color-burn": function() {
                f = 255 === u ? 255: 0 === s ? 0: v(0, 255 - 255 * (255 - u) / s),
                _ = 255 === l ? 255: 0 === a ? 0: v(0, 255 - 255 * (255 - l) / a),
                g = 255 === c ? 255: 0 === o ? 0: v(0, 255 - 255 * (255 - c) / o)
            },
            darken: function() {
                f = s > u ? u: s,
                _ = a > l ? l: a,
        ...
        w = this.nativeModes = e.each(["source-over", "source-in", "source-out", "source-atop", "destination-over", "destination-in", "destination-out", "destination-atop", "lighter", "darker", "copy", "xor"], 
        function(t) {
            this[t] = !0
        },
        {}),
        ...
        function(t, e) {
            ...
            try {
                ...
                x.globalCompositeOperation === e && (x.fillStyle = n ? "#a00": "#300", x.fillRect(0, 0, 1, 1), i = x.getImageData(0, 0, 1, 1).data[0] !== n ? 170: 51)
            } catch(r) {}
            x.restore(),
            w[e] = i
        }),
    ...
    function() {
        ...
        function r(t, e, n) {
            ...
            if (!i.isIdentity()) {
                ...
                if (h && !h.shearing) {
                    ...
                    l = h.rotation,
                    c = h.scaling;
                    r && !r.isZero() && u.push("translate(" + S.point(r) + ")"),
                    l && u.push("rotate(" + S.number(l) + ")"),
                    o.isZero(c.x - 1) && o.isZero(c.y - 1) || u.push("scale(" + S.point(c) + ")"),
                    s.transform = u.join(" ")
                } else s.transform = "matrix(" + i.getValues().join(",") + ")"
            }
            return s
        }
        function s(e, i) {
            for (var s = r(e), a = e._children, o = n("g", s), h = 0, u = a.length; u > h; h++) {
                var l = a[h],
                c = b(l, i);
        ...
        function u(t, e) {
            ...
            if (t.isPolygon()) if (o.length >= 3) {
                ...
                var h = [];
                for (i = 0, l = o.length; l > i; i++) h.push(S.point(o[i]._point));
                a = {
                    points: h.join(" ")
                }
            } else {
        ...
        function c(t) {
            ...
            return i && ("circle" === e ? s.r = i: (s.rx = i.width, s.ry = i.height)),
            n(e, s)
        }
        function d(t) {
            var e = r(t, !0),
        ...
        function f(t, e) {
            ...
            }), a.appendChild(b(o, e)), w(s, a, "symbol")),
            i.href = "#" + a.id,
            i.x += h.x,
            i.y += h.y,
        ...
        function p(n, i) {
            var r = {},
            s = n.getParent();
            return null != n._name && (r.id = n._name),
            e.each(ee, 
            function(t) {
                var i = t.get,
                a = t.type,
                ...
                if (!s || !e.equals(s[i](), o)) {
                    if ("color" === a && null != o) {
                        var h = o.getAlpha();
                        1 > h && (r[t.attribute + "-opacity"] = h)
                    }
                    r[t.attribute] = null == o ? "none": "number" === a ? S.number(o) : "color" === a ? o.gradient ? _(o, n) : o.toCSS(!0) : "array" === a ? o.join(",") : "lookup" === a ? t.toSVG[o] : o
                }
            }),
            1 === r.opacity && delete r.opacity,
            null == n._visibility || n._visibility || (r.visibility = "hidden"),
            t(i, r)
        }
        function m(t, e) {
            return P || (P = {
        ...
        function x(t, e) {
            ...
            if (P) {
                ...
                for (var s in P.svgs) r || (i || (i = n("svg"), i.appendChild(t)), r = i.insertBefore(n("defs"), i.firstChild)),
        ...
        function b(t, e) {
            ...
            i = n && n(t, e);
            if (i && t._data) {
                var r = JSON.stringify(t._data);
                "{}" !== r && i.setAttribute("data-paper-data", r)
            }
            return i && p(t, i)
        }
        function C(t) {
        ...
        v.inject({
            exportSVG: function(t) {
                t = C(t);
                for (var e = this.layers, i = this.getView().getSize(), r = n("svg", {
                    x: 0,
                    y: 0,
                    width: i.width,
                    height: i.height,
                ...
                }), s = 0, a = e.length; a > s; s++) r.appendChild(b(e[s], t));
                return x(r, t)
            }
        })
    },
    ...
    function() {
        ...
        function a(t, e, n, i) {
            ...
            h = o._currentStyle,
            u = [];
            s || (a = x(a, t, n), o._currentStyle = a._style.clone());
            for (var l = 0, c = r.length; c > l; l++) {
                var d,
                f = r[l];
                1 !== f.nodeType || !(d = P(f, !1, i)) || d instanceof m || u.push(d)
            }
            return a.addChildren(u),
            s && (a = x(a.reduce(), t, n)),
            o._currentStyle = h,
        ...
        function u(t) {
            ...
            return e.match(/m/gi).length > 1 || /z\S+/i.test(e) ? new O(n) : new T(n)
        }
        function l(t, e) {
            var r,
            ...
            f,
            _;
            return a ? (d = i(t, "cx", "cy"), f = d.add(n(t, "r"), 0), _ = i(t, "fx", "fy", !0)) : (d = i(t, "x1", "y1"), f = i(t, "x2", "y2")),
            x(new D(r, d, f, _), t),
            null
        }
        function d(t, e, n, i) {
            for (var r = (i.getAttribute(n) || "").split(/\)\s*/g), s = new g, a = 0, o = r.length; o > a; a++) {
                var h = r[a];
                if (!h) break;
                for (var u = h.split("("), l = u[0], c = u[1].split(/[\s,]+/g), d = 0, f = c.length; f > d; d++) c[d] = parseFloat(c[d]);
                switch (l) {
                case "matrix":
        ...
        function P(t, e, n) {
            ...
            var r = t,
            s = paper;
            if (e) if ("string" != typeof t || /^.*</.test(t)) {
                ...
                if (r = document.getElementById(t), !r) return K.request("get", t, i);
                t = null
            }
            ...
            c = s.settings,
            d = c.applyMatrix;
            return c.applyMatrix = !1,
            o = u && u(r, h, e, n) || null,
            c.applyMatrix = d,
            o && (o instanceof w || (o = x(o, r, e)), n.expandShapes && o instanceof b && (o.remove(), o = o.toPath()), l && (o._data = JSON.parse(l))),
            e && (z = {}),
            o
        }
        var k = {
            "#document": function(t, e, n, i) {
                for (var r = t.childNodes, s = 0, a = r.length; a > s; s++) {
                    ...
                    if (1 === o.nodeType) {
                        ...
                        var u = P(o, n, i);
                        return h ? t.insertBefore(o, h) : t.appendChild(o),
                        u
                    }
                }
            },
            ...
            use: function(t) {
                ...
                r = z[e],
                s = i(t, "x", "y");
                return r ? r instanceof m ? r.place(s) : r.clone().translate(s) : null
            },
            circle: function(t) {
            ...
            line: function(t) {
                return new T.Line(i(t, "x1", "y1"), i(t, "x2", "y2"))
            },
            text: function(t) {
        ...
        },
        {
            ...
            viewBox: function(t, e, n, i, a) {
                ...
                if (t instanceof w) {
                    ...
                    l = (new g).translate(o.getPoint()).scale(u);
                    t.transform(l.inverted())
                } else if (t instanceof m) {
                    h && o.setSize(h);
                    var c = "visible" != p(i, "overflow", a),
                    d = t._definition;
                    c && !o.contains(d.getBounds()) && (c = new b.Rectangle(o).transform(d._matrix), c.setClipMask(!0), d.addChild(c))
                }
            }
        }),
        z = {};
    ...
    e.exports.PaperScript = function() {
        ...
        function i(t) {
            ...
            function n(n) {
                return t.substring(e(n.range[0]), e(n.range[1]))
            }
            function i(n, i) {
                for (var r = e(n.range[0]), a = e(n.range[1]), o = 0, h = s.length - 1; h >= 0; h--) if (r > s[h][0]) {
                    o = h + 1;
                    break
                }
                s.splice(o, 0, [r, i.length - a + r]),
                t = t.substring(0, r) + i + t.substring(a)
            }
            function r(t, e) {
                if (t) {
                    for (var s in t) if ("range" !== s) {
                        var a = t[s];
                        if (Array.isArray(a)) for (var o = 0, h = a.length; h > o; o++) r(a[o], t);
                        else a && "object" == typeof a && r(a, t)
                    }
                    switch (t && t.type) {
                    case "UnaryExpression":
                        if (t.operator in f && "Literal" !== t.argument.type) {
                            var u = n(t.argument);
                            i(t, '$_("' + t.operator + '", ' + u + ")")
                        }
                        break;
                    case "BinaryExpression":
                        if (t.operator in d && "Literal" !== t.left.type) {
                            var l = n(t.left),
                            c = n(t.right);
                            i(t, "_$_(" + l + ', "' + t.operator + '", ' + c + ")")
                        }
                        break;
                    case "UpdateExpression":
                    case "AssignmentExpression":
                        if (!e || !("ForStatement" === e.type || "BinaryExpression" === e.type && /^[=!<>]/.test(e.operator) || "MemberExpression" === e.type && e.computed)) if ("UpdateExpression" === t.type) {
                            if (!t.prefix) {
                                var u = n(t.argument);
                                i(t, u + " = _$_(" + u + ', "' + t.operator[0] + '", 1)')
                            }
                        } else if (/^.=$/.test(t.operator) && "Literal" !== t.left.type) {
                            var l = n(t.left),
                            c = n(t.right);
                            i(t, l + " = _$_(" + l + ', "' + t.operator[0] + '", ' + c + ")")
                        }
                    }
                }
            }
            var s = [];
            return r(l.acorn.parse(t, {
                ranges: !0
            })),
            t
        }
        function s(r, s) {
            function a(t, e) {
                for (var n in t) ! e && /^_/.test(n) || !RegExp("\\b" + n.replace(/\$/g, "\\$") + "\\b").test(r) || (f.push(n), _.push(t[n]))
            }
            paper = s;
            var o,
            u = s.getView(),
            l = /\s+on(?:Key|Mouse)(?:Up|Down|Move|Drag)\b/.test(r) ? new Y: null,
            c = l ? l._events: [],
            d = ["onFrame", "onResize"].concat(c),
            f = [],
            _ = [];
            r = i(r),
            a({
            ...
            d = e.each(d, 
            function(t) {
                RegExp("\\s+" + t + "\\b").test(r) && (f.push(t), this.push(t + ": " + t))
            },
            []).join(", "),
            d && (r += "\nreturn { " + d + " };");
            var g = window.InstallTrigger;
            if (g || window.chrome) {
                var p = document.createElement("script"),
                v = document.head;
                g && (r = "\n" + r),
                p.appendChild(document.createTextNode("paper._execute = function(" + f + ") {" + r + "\n}")),
                v.appendChild(p),
                o = paper._execute,
            ...
            u && (m.onResize && u.setOnResize(m.onResize), u.fire("resize", {
                size: u.size,
                delta: new h
            }), m.onFrame && u.setOnFrame(m.onFrame), u.update())
        }
        function a() {
            e.each(document.getElementsByTagName("script"), 
            function(t) {
                if (/^text\/(?:x-|)paperscript$/.test(t.type) && !t.getAttribute("data-paper-ignore")) {
                    var e = r.getAttribute(t, "canvas"),
                    n = r.get(e) || new r(t).setup(e),
                    i = t.src;
                    i ? K.request("get", i, 
                    function(t) {
                        s(t, n)
                    }) : s(t.innerHTML, n),
                    t.setAttribute("data-paper-ignore", !0)
                }
            },
            this)
        }
        ...
        l = this; ! 
        function(t, e) {
            return "object" == typeof o && "object" == typeof module ? e(o) : "function" == typeof u && u.amd ? u(["exports"], e) : (e(t.acorn || (t.acorn = {})), void 0)
        } (this, 
        function(t) {
            "use strict";
            function e(t) {
            ...
            function o() {
                ...
                if ( - 1 === i && n(ve - 2, "Unterminated comment"), ve = i + 2, ce.locations) {
                    Yn.lastIndex = e;
                    for (var s; (s = Yn.exec(de)) && s.index < ve;)++Pe,
                    ke = s.index + s[0].length
                }
                ce.onComment && ce.onComment(!0, de.slice(e + 2, i), e, ve, t, ce.locations && new r)
            }
            function h() {
                for (var t = ve, e = ce.onComment && ce.locations && new r, n = de.charCodeAt(ve += 2); fe > ve && 10 !== n && 13 !== n && 8232 !== n && 8329 !== n;)++ve,
                n = de.charCodeAt(ve);
            ...
            function u() {
                for (; fe > ve;) {
                    ...
                    ke = ve;
                        ...
                        if (! (t >= 5760 && Un.test(String.fromCharCode(t)))) break; ++ve
                    }
                }
            }
            function l() {
            ...
            function f(t) {
                var e = de.charCodeAt(ve + 1);
                return e === t ? w(124 === t ? In: An, 2) : 61 === e ? w(Pn, 2) : w(124 === t ? Tn: Ln, 1)
            }
            function _() {
                var t = de.charCodeAt(ve + 1);
                return 61 === t ? w(Pn, 2) : w(On, 1)
            }
            function g(t) {
                var e = de.charCodeAt(ve + 1);
            ...
            function p(t) {
                var e = de.charCodeAt(ve + 1),
                n = 1;
                return e === t ? (n = 62 === t && 62 === de.charCodeAt(ve + 2) ? 3: 2, 61 === de.charCodeAt(ve + n) ? w(Pn, n + 1) : w(jn, n)) : (61 === e && (n = 61 === de.charCodeAt(ve + 2) ? 3: 2), w(Nn, n))
            }
            function v(t) {
                var e = de.charCodeAt(ve + 1);
                return 61 === e ? w(En, 61 === de.charCodeAt(ve + 2) ? 3: 2) : w(61 === t ? Sn: zn, 1)
            }
            function m(t) {
                switch (t) {
                case 46:
            ...
            function x() {
                for (var t, e, i = "", r = ve;;) {
                    ...
                    var s = de.charAt(ve);
                    if (Jn.test(s) && n(r, "Unterminated regular expression"), t) t = !1;
                    else {
                        if ("[" === s) e = !0;
                        else if ("]" === s && e) e = !1;
                        else if ("/" === s && !e) break;
                ...
                var i = de.slice(r, ve); ++ve;
                var o = M();
                return o && !/^[gmsiy]*$/.test(o) && n(r, "Invalid regexp flag"),
                a(Ne, RegExp(i, o))
            }
            function b(t, e) {
                for (var n = ve, i = 0, r = 0, s = null == e ? 1 / 0: e; s > r; ++r) {
                    var a,
                    o = de.charCodeAt(ve);
                    if (a = o >= 97 ? o - 97 + 10: o >= 65 ? o - 65 + 10: o >= 48 && 57 >= o ? o - 48: 1 / 0, a >= t) break; ++ve,
                    i = i * t + a
                }
            ...
            function C() {
                ve += 2;
                var t = b(16);
                return null == t && n(me + 2, "Expected hexadecimal number"),
                Kn(de.charCodeAt(ve)) && n(ve, "Identifier directly after number"),
                a(Ee, t)
            }
            function S(t) {
                var e = ve,
                ...
                var s = de.charCodeAt(ve); (69 === s || 101 === s) && (s = de.charCodeAt(++ve), (43 === s || 45 === s) && ++ve, null === b(10) && n(e, "Invalid number"), i = !0),
                Kn(de.charCodeAt(ve)) && n(ve, "Identifier directly after number");
                var o,
                h = de.slice(e, ve);
                return i ? o = parseFloat(h) : r && 1 !== h.length ? /[89]/.test(h) || Oe ? n(e, "Invalid number") : o = parseInt(h, 8) : o = parseInt(h, 10),
                a(Ee, o)
            }
            function P(t) {
                ve++;
                for (var e = "";;) {
                    ...
                    if (92 === i) {
                        ...
                        if ("0" === r && (r = null), ++ve, r) Oe && n(ve - 2, "Octal literal in strict mode"),
                    ...
                    } else(13 === i || 10 === i || 8232 === i || 8329 === i) && n(me, "Unterminated string constant"),
                    e += String.fromCharCode(i),
                    ++ve
                }
            }
            function k(t) {
                var e = b(16, t);
                return null === e && n(me, "Bad character escape sequence"),
                e
            }
            function M() {
                Rn = !1;
                for (var t, e = !0, i = ve;;) {
                    ...
                    if (Qn(r)) Rn && (t += de.charAt(ve)),
                    ++ve;
                    else {
                        if (92 !== r) break;
                        Rn || (t = de.slice(i, ve)),
                        Rn = !0,
                        117 != de.charCodeAt(++ve) && n(ve, "Expecting Unicode escape sequence \\uXXXX"),
                        ++ve;
                        var s = k(4),
                        a = String.fromCharCode(s);
                        a || n(ve - 1, "Invalid Unicode escape"),
                        (e ? Kn(s) : Qn(s)) || n(ve - 4, "Invalid Unicode escape"),
                        t += a
                    }
                    e = !1
                }
            ...
            function z() {
                var t = M(),
                e = De;
                return Rn || (Hn(t) ? e = cn[t] : (ce.forbidReserved && (3 === ce.ecmaVersion ? Fn: Vn)(t) || Oe && qn(t)) && n(me, "The keyword '" + t + "' is reserved")),
                a(e, t)
            }
            function I() {
                Me = me,
            ...
            function A(t) {
                for (Oe = t, ve = ze; ke > ve;) ke = de.lastIndexOf("\n", ke - 2) + 1,
                --Pe;
                u(),
                y()
            }
            ...
            function L() {
                var t = new T;
                return ce.locations && (t.loc = new O),
            ...
            function E(t) {
                ...
                ce.locations && (e.loc = new O, e.loc.start = t.loc.start),
            ...
            function D(t) {
                return be === t ? (I(), !0) : void 0
            }
            function B() {
                return ! ce.strictSemicolons && (be === Be || be === gn || Jn.test(de.slice(ze, me)))
            }
            function R() {
                D(yn) || B() || V()
            }
            ...
            function q(t) {
                ...
                Oe && "Identifier" === t.type && Zn(t.name) && n(t.start, "Assigning to " + t.name + " in strict mode")
            }
            function Z(t) {
                Me = ze = ve,
                ce.locations && (Ie = new r),
                Ae = Oe = null,
                Te = [],
                y();
                var e = t || L(),
            ...
            function H() {
                ...
                case qe:
                    I();
                    var i = t === Re;
                    D(yn) || B() ? e.label = null: be !== De ? V() : (e.label = le(), R());
                    ...
                    return r === Te.length && n(e.start, "Unsyntactic " + t.keyword),
                    N(e, i ? "BreakStatement": "ContinueStatement");
                case Ze:
                    return I(),
                    R(),
                    N(e, "DebuggerStatement");
                case Ue:
                    return I(),
                    Te.push(ti),
                    e.body = H(),
                ...
                case $e:
                    if (I(), Te.push(ti), F(pn), be === yn) return G(e, null);
                    if (be === en) {
                        var a = L();
                        return I(),
                        X(a, !0),
                        1 === a.declarations.length && D(ln) ? $(e, a) : G(e, a)
                    }
                    var a = J(!1, !0);
                ...
                case Je:
                    ...
                    e.test = U(),
                    e.consequent = H(),
                    e.alternate = D(We) ? H() : null,
                    N(e, "IfStatement");
                case Ye:
                    return Ae || n(me, "'return' outside of function"),
                    I(),
                    D(yn) || B() ? e.argument = null: (e.argument = J(), R()),
                    N(e, "ReturnStatement");
                case Ke:
                    I(),
                    e.discriminant = U(),
                    ...
                    F(_n),
                    Te.push(ei);
                    for (var o, h; be != gn;) if (be === Fe || be === He) {
                        var u = be === Fe;
                        o && N(o, "SwitchCase"),
                        e.cases.push(o = L()),
                        o.consequent = [],
                        I(),
                        u ? o.test = J() : (h && n(Me, "Multiple default clauses"), h = !0, o.test = null),
                        F(wn)
                    } else o || V(),
                    o.consequent.push(H());
                    return o && N(o, "SwitchCase"),
                    I(),
                    Te.pop(),
                    N(e, "SwitchStatement");
                case Qe:
                    return I(),
                    Jn.test(de.slice(ze, me)) && n(ze, "Illegal newline after throw"),
                    e.argument = J(),
                    R(),
                    N(e, "ThrowStatement");
                case tn:
                    if (I(), e.block = W(), e.handler = null, be === Ve) {
                        var l = L();
                        I(),
                        F(pn),
                        l.param = le(),
                        Oe && Zn(l.param.name) && n(l.param.start, "Binding " + l.param.name + " in strict mode"),
                        F(vn),
                        l.guard = null,
                        l.body = W(),
                        e.handler = N(l, "CatchClause")
                    }
                    return e.guardedHandlers = Le,
                    e.finalizer = D(Ge) ? W() : null,
                    e.handler || e.finalizer || n(e.start, "Missing catch or finally clause"),
                    N(e, "TryStatement");
                case en:
                    return I(),
                    e = X(e),
                ...
                case nn:
                    ...
                    N(e, "WhileStatement");
                case rn:
                    return Oe && n(me, "'with' in strict mode"),
                    I(),
                    e.object = U(),
                    e.body = H(),
                    N(e, "WithStatement");
                ...
                default:
                    ...
                    if (t === De && "Identifier" === d.type && D(wn)) {
                        for (var r = 0; r < Te.length; ++r) Te[r].name === c && n(d.start, "Label '" + c + "' is already declared");
            ...
            function X(t, e) {
                for (t.declarations = [], t.kind = "var";;) {
                    var i = L();
                    if (i.id = le(), Oe && Zn(i.id.name) && n(i.id.start, "Binding " + i.id.name + " in strict mode"), i.init = D(Sn) ? J(!0, e) : null, t.declarations.push(N(i, "VariableDeclarator")), !D(mn)) break
                }
            ...
            function J(t, e) {
                ...
                if (!t && be === mn) {
                    var i = E(n);
                    for (i.expressions = [n]; D(mn);) i.expressions.push(Y(e));
            ...
            function te(t, e, n) {
                ...
                if (null != i && (!n || be !== ln) && i > e) {
                    ...
                    I(),
                    r.right = te(ee(), i, n);
                    var r = N(r, /&&|\|\|/.test(r.operator) ? "LogicalExpression": "BinaryExpression");
                    return te(r, e, n)
                }
                return t
            }
            function ee() {
                if (be.prefix) {
                    var t = L(),
                    e = be.isUpdate;
                    return t.operator = Ce,
                    t.prefix = !0,
                    I(),
                    t.argument = ee(),
                    e ? q(t.argument) : Oe && "delete" === t.operator && "Identifier" === t.argument.type && n(t.start, "Deleting local variable in strict mode"),
            ...
            function re() {
                ...
                case pn:
                    ...
                    return i.start = n,
                    i.end = ye,
                    ce.locations && (i.loc.start = e, i.loc.end = xe),
            ...
            function ae() {
                ...
                e = !0,
                i = !1;
                for (t.properties = [], I(); ! D(gn);) {
                    if (e) e = !1;
                    else if (F(mn), ce.allowTrailingCommas && D(gn)) break;
                    var r,
                    s = {
                        key: oe()
                    },
                    a = !1;
                    if (D(wn) ? (s.value = J(!0), r = s.kind = "init") : ce.ecmaVersion >= 5 && "Identifier" === s.key.type && ("get" === s.key.name || "set" === s.key.name) ? (a = i = !0, r = s.kind = s.key.name, s.key = oe(), be !== pn && V(), s.value = he(L(), !1)) : V(), "Identifier" === s.key.type && (Oe || i)) for (var o = 0; o < t.properties.length; ++o) {
                        var h = t.properties[o];
                        if (h.key.name === s.key.name) {
                            var u = r == h.kind || a && "init" === h.kind || "init" === r && ("get" === h.kind || "set" === h.kind);
                            u && !Oe && "init" === r && "init" === h.kind && (u = !1),
                            u && n(s.key.start, "Redefinition of property")
                        }
                    }
                    t.properties.push(s)
                }
            ...
            function he(t, e) {
                ...
                t.params = [];
                var i = !0;
                for (F(pn); ! D(vn);) i ? i = !1: F(mn),
                t.params.push(le());
                var r = Ae,
                s = Te;
                if (Ae = !0, Te = [], t.body = W(!0), Ae = r, Te = s, Oe || t.body.body.length && j(t.body.body[0])) for (var a = t.id ? -1: 0; a < t.params.length; ++a) {
                    var o = 0 > a ? t.id: t.params[a];
                    if ((qn(o.name) || Zn(o.name)) && n(o.start, "Defining '" + o.name + "' in strict mode"), a >= 0) for (var h = 0; a > h; ++h) o.name === t.params[h].name && n(o.start, "Argument name clash in strict mode")
                }
            ...
            function ue(t, e, n) {
                for (var i = [], r = !0; ! D(t);) {
                    if (r) r = !1;
                    else if (F(mn), e && ce.allowTrailingCommas && D(t)) break;
            ...
            function le(t) {
                var e = L();
                return e.name = be === De ? Ce: t && !ce.forbidReserved && be.keyword || V(),
                I(),
                N(e, "Identifier")
            }
            t.version = "0.3.2";
            ...
            t.tokenize = function(t, n) {
                ...
                return i.jumpTo = function(t, e) {
                    if (ve = t, ce.locations) {
                        Pe = 1,
                        ke = Yn.lastIndex = 0;
                        for (var n; (n = Yn.exec(de)) && n.index < t;)++Pe,
                        ke = n.index + n[0].length
                    }
                    Se = e,
                    u()
                },
            ...
            var Rn,
            Fn = i("abstract boolean byte char class double enum export extends final float goto implements import int interface long native package private protected public short static super synchronized throws transient volatile"),
            Vn = i("class enum extends super const export import"),
            qn = i("implements interface let package private protected public static yield"),
            Zn = i("eval arguments"),
            Hn = i("break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this"),
            Un = /[\u1680\u180e\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]/,
            Wn = "\xaa\xb5\xba\xc0-\xd6\xd8-\xf6\xf8-\u02c1\u02c6-\u02d1\u02e0-\u02e4\u02ec\u02ee\u0370-\u0374\u0376\u0377\u037a-\u037d\u0386\u0388-\u038a\u038c\u038e-\u03a1\u03a3-\u03f5\u03f7-\u0481\u048a-\u0527\u0531-\u0556\u0559\u0561-\u0587\u05d0-\u05ea\u05f0-\u05f2\u0620-\u064a\u066e\u066f\u0671-\u06d3\u06d5\u06e5\u06e6\u06ee\u06ef\u06fa-\u06fc\u06ff\u0710\u0712-\u072f\u074d-\u07a5\u07b1\u07ca-\u07ea\u07f4\u07f5\u07fa\u0800-\u0815\u081a\u0824\u0828\u0840-\u0858\u08a0\u08a2-\u08ac\u0904-\u0939\u093d\u0950\u0958-\u0961\u0971-\u0977\u0979-\u097f\u0985-\u098c\u098f\u0990\u0993-\u09a8\u09aa-\u09b0\u09b2\u09b6-\u09b9\u09bd\u09ce\u09dc\u09dd\u09df-\u09e1\u09f0\u09f1\u0a05-\u0a0a\u0a0f\u0a10\u0a13-\u0a28\u0a2a-\u0a30\u0a32\u0a33\u0a35\u0a36\u0a38\u0a39\u0a59-\u0a5c\u0a5e\u0a72-\u0a74\u0a85-\u0a8d\u0a8f-\u0a91\u0a93-\u0aa8\u0aaa-\u0ab0\u0ab2\u0ab3\u0ab5-\u0ab9\u0abd\u0ad0\u0ae0\u0ae1\u0b05-\u0b0c\u0b0f\u0b10\u0b13-\u0b28\u0b2a-\u0b30\u0b32\u0b33\u0b35-\u0b39\u0b3d\u0b5c\u0b5d\u0b5f-\u0b61\u0b71\u0b83\u0b85-\u0b8a\u0b8e-\u0b90\u0b92-\u0b95\u0b99\u0b9a\u0b9c\u0b9e\u0b9f\u0ba3\u0ba4\u0ba8-\u0baa\u0bae-\u0bb9\u0bd0\u0c05-\u0c0c\u0c0e-\u0c10\u0c12-\u0c28\u0c2a-\u0c33\u0c35-\u0c39\u0c3d\u0c58\u0c59\u0c60\u0c61\u0c85-\u0c8c\u0c8e-\u0c90\u0c92-\u0ca8\u0caa-\u0cb3\u0cb5-\u0cb9\u0cbd\u0cde\u0ce0\u0ce1\u0cf1\u0cf2\u0d05-\u0d0c\u0d0e-\u0d10\u0d12-\u0d3a\u0d3d\u0d4e\u0d60\u0d61\u0d7a-\u0d7f\u0d85-\u0d96\u0d9a-\u0db1\u0db3-\u0dbb\u0dbd\u0dc0-\u0dc6\u0e01-\u0e30\u0e32\u0e33\u0e40-\u0e46\u0e81\u0e82\u0e84\u0e87\u0e88\u0e8a\u0e8d\u0e94-\u0e97\u0e99-\u0e9f\u0ea1-\u0ea3\u0ea5\u0ea7\u0eaa\u0eab\u0ead-\u0eb0\u0eb2\u0eb3\u0ebd\u0ec0-\u0ec4\u0ec6\u0edc-\u0edf\u0f00\u0f40-\u0f47\u0f49-\u0f6c\u0f88-\u0f8c\u1000-\u102a\u103f\u1050-\u1055\u105a-\u105d\u1061\u1065\u1066\u106e-\u1070\u1075-\u1081\u108e\u10a0-\u10c5\u10c7\u10cd\u10d0-\u10fa\u10fc-\u1248\u124a-\u124d\u1250-\u1256\u1258\u125a-\u125d\u1260-\u1288\u128a-\u128d\u1290-\u12b0\u12b2-\u12b5\u12b8-\u12be\u12c0\u12c2-\u12c5\u12c8-\u12d6\u12d8-\u1310\u1312-\u1315\u1318-\u135a\u1380-\u138f\u13a0-\u13f4\u1401-\u166c\u166f-\u167f\u1681-\u169a\u16a0-\u16ea\u16ee-\u16f0\u1700-\u170c\u170e-\u1711\u1720-\u1731\u1740-\u1751\u1760-\u176c\u176e-\u1770\u1780-\u17b3\u17d7\u17dc\u1820-\u1877\u1880-\u18a8\u18aa\u18b0-\u18f5\u1900-\u191c\u1950-\u196d\u1970-\u1974\u1980-\u19ab\u19c1-\u19c7\u1a00-\u1a16\u1a20-\u1a54\u1aa7\u1b05-\u1b33\u1b45-\u1b4b\u1b83-\u1ba0\u1bae\u1baf\u1bba-\u1be5\u1c00-\u1c23\u1c4d-\u1c4f\u1c5a-\u1c7d\u1ce9-\u1cec\u1cee-\u1cf1\u1cf5\u1cf6\u1d00-\u1dbf\u1e00-\u1f15\u1f18-\u1f1d\u1f20-\u1f45\u1f48-\u1f4d\u1f50-\u1f57\u1f59\u1f5b\u1f5d\u1f5f-\u1f7d\u1f80-\u1fb4\u1fb6-\u1fbc\u1fbe\u1fc2-\u1fc4\u1fc6-\u1fcc\u1fd0-\u1fd3\u1fd6-\u1fdb\u1fe0-\u1fec\u1ff2-\u1ff4\u1ff6-\u1ffc\u2071\u207f\u2090-\u209c\u2102\u2107\u210a-\u2113\u2115\u2119-\u211d\u2124\u2126\u2128\u212a-\u212d\u212f-\u2139\u213c-\u213f\u2145-\u2149\u214e\u2160-\u2188\u2c00-\u2c2e\u2c30-\u2c5e\u2c60-\u2ce4\u2ceb-\u2cee\u2cf2\u2cf3\u2d00-\u2d25\u2d27\u2d2d\u2d30-\u2d67\u2d6f\u2d80-\u2d96\u2da0-\u2da6\u2da8-\u2dae\u2db0-\u2db6\u2db8-\u2dbe\u2dc0-\u2dc6\u2dc8-\u2dce\u2dd0-\u2dd6\u2dd8-\u2dde\u2e2f\u3005-\u3007\u3021-\u3029\u3031-\u3035\u3038-\u303c\u3041-\u3096\u309d-\u309f\u30a1-\u30fa\u30fc-\u30ff\u3105-\u312d\u3131-\u318e\u31a0-\u31ba\u31f0-\u31ff\u3400-\u4db5\u4e00-\u9fcc\ua000-\ua48c\ua4d0-\ua4fd\ua500-\ua60c\ua610-\ua61f\ua62a\ua62b\ua640-\ua66e\ua67f-\ua697\ua6a0-\ua6ef\ua717-\ua71f\ua722-\ua788\ua78b-\ua78e\ua790-\ua793\ua7a0-\ua7aa\ua7f8-\ua801\ua803-\ua805\ua807-\ua80a\ua80c-\ua822\ua840-\ua873\ua882-\ua8b3\ua8f2-\ua8f7\ua8fb\ua90a-\ua925\ua930-\ua946\ua960-\ua97c\ua984-\ua9b2\ua9cf\uaa00-\uaa28\uaa40-\uaa42\uaa44-\uaa4b\uaa60-\uaa76\uaa7a\uaa80-\uaaaf\uaab1\uaab5\uaab6\uaab9-\uaabd\uaac0\uaac2\uaadb-\uaadd\uaae0-\uaaea\uaaf2-\uaaf4\uab01-\uab06\uab09-\uab0e\uab11-\uab16\uab20-\uab26\uab28-\uab2e\uabc0-\uabe2\uac00-\ud7a3\ud7b0-\ud7c6\ud7cb-\ud7fb\uf900-\ufa6d\ufa70-\ufad9\ufb00-\ufb06\ufb13-\ufb17\ufb1d\ufb1f-\ufb28\ufb2a-\ufb36\ufb38-\ufb3c\ufb3e\ufb40\ufb41\ufb43\ufb44\ufb46-\ufbb1\ufbd3-\ufd3d\ufd50-\ufd8f\ufd92-\ufdc7\ufdf0-\ufdfb\ufe70-\ufe74\ufe76-\ufefc\uff21-\uff3a\uff41-\uff5a\uff66-\uffbe\uffc2-\uffc7\uffca-\uffcf\uffd2-\uffd7\uffda-\uffdc",
            Gn = "\u0300-\u036f\u0483-\u0487\u0591-\u05bd\u05bf\u05c1\u05c2\u05c4\u05c5\u05c7\u0610-\u061a\u0620-\u0649\u0672-\u06d3\u06e7-\u06e8\u06fb-\u06fc\u0730-\u074a\u0800-\u0814\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0840-\u0857\u08e4-\u08fe\u0900-\u0903\u093a-\u093c\u093e-\u094f\u0951-\u0957\u0962-\u0963\u0966-\u096f\u0981-\u0983\u09bc\u09be-\u09c4\u09c7\u09c8\u09d7\u09df-\u09e0\u0a01-\u0a03\u0a3c\u0a3e-\u0a42\u0a47\u0a48\u0a4b-\u0a4d\u0a51\u0a66-\u0a71\u0a75\u0a81-\u0a83\u0abc\u0abe-\u0ac5\u0ac7-\u0ac9\u0acb-\u0acd\u0ae2-\u0ae3\u0ae6-\u0aef\u0b01-\u0b03\u0b3c\u0b3e-\u0b44\u0b47\u0b48\u0b4b-\u0b4d\u0b56\u0b57\u0b5f-\u0b60\u0b66-\u0b6f\u0b82\u0bbe-\u0bc2\u0bc6-\u0bc8\u0bca-\u0bcd\u0bd7\u0be6-\u0bef\u0c01-\u0c03\u0c46-\u0c48\u0c4a-\u0c4d\u0c55\u0c56\u0c62-\u0c63\u0c66-\u0c6f\u0c82\u0c83\u0cbc\u0cbe-\u0cc4\u0cc6-\u0cc8\u0cca-\u0ccd\u0cd5\u0cd6\u0ce2-\u0ce3\u0ce6-\u0cef\u0d02\u0d03\u0d46-\u0d48\u0d57\u0d62-\u0d63\u0d66-\u0d6f\u0d82\u0d83\u0dca\u0dcf-\u0dd4\u0dd6\u0dd8-\u0ddf\u0df2\u0df3\u0e34-\u0e3a\u0e40-\u0e45\u0e50-\u0e59\u0eb4-\u0eb9\u0ec8-\u0ecd\u0ed0-\u0ed9\u0f18\u0f19\u0f20-\u0f29\u0f35\u0f37\u0f39\u0f41-\u0f47\u0f71-\u0f84\u0f86-\u0f87\u0f8d-\u0f97\u0f99-\u0fbc\u0fc6\u1000-\u1029\u1040-\u1049\u1067-\u106d\u1071-\u1074\u1082-\u108d\u108f-\u109d\u135d-\u135f\u170e-\u1710\u1720-\u1730\u1740-\u1750\u1772\u1773\u1780-\u17b2\u17dd\u17e0-\u17e9\u180b-\u180d\u1810-\u1819\u1920-\u192b\u1930-\u193b\u1951-\u196d\u19b0-\u19c0\u19c8-\u19c9\u19d0-\u19d9\u1a00-\u1a15\u1a20-\u1a53\u1a60-\u1a7c\u1a7f-\u1a89\u1a90-\u1a99\u1b46-\u1b4b\u1b50-\u1b59\u1b6b-\u1b73\u1bb0-\u1bb9\u1be6-\u1bf3\u1c00-\u1c22\u1c40-\u1c49\u1c5b-\u1c7d\u1cd0-\u1cd2\u1d00-\u1dbe\u1e01-\u1f15\u200c\u200d\u203f\u2040\u2054\u20d0-\u20dc\u20e1\u20e5-\u20f0\u2d81-\u2d96\u2de0-\u2dff\u3021-\u3028\u3099\u309a\ua640-\ua66d\ua674-\ua67d\ua69f\ua6f0-\ua6f1\ua7f8-\ua800\ua806\ua80b\ua823-\ua827\ua880-\ua881\ua8b4-\ua8c4\ua8d0-\ua8d9\ua8f3-\ua8f7\ua900-\ua909\ua926-\ua92d\ua930-\ua945\ua980-\ua983\ua9b3-\ua9c0\uaa00-\uaa27\uaa40-\uaa41\uaa4c-\uaa4d\uaa50-\uaa59\uaa7b\uaae0-\uaae9\uaaf2-\uaaf3\uabc0-\uabe1\uabec\uabed\uabf0-\uabf9\ufb20-\ufb28\ufe00-\ufe0f\ufe20-\ufe26\ufe33\ufe34\ufe4d-\ufe4f\uff10-\uff19\uff3f",
            $n = RegExp("[" + Wn + "]"),
            Xn = RegExp("[" + Wn + Gn + "]"),
            Jn = /[\n\r\u2028\u2029]/,
            Yn = /\r\n|[\n\r\u2028\u2029]/g,
        ...
        _ = e.each(["add", "subtract", "multiply", "divide", "modulo", "negate"], 
        function(t) {
            this["__" + t] = "#" + t
        },
        {});
        ...
        c.inject(_),
        D.inject(_),
        "complete" === document.readyState ? setTimeout(a) : q.add(window, {
            load: a
        }),
        {
            compile: i,
    ...
    "function" == typeof define && define.amd && define("paper", paper),
    paper
};