...
class AfDboperator(object):
    ...
    #     # 1.1 通讯录vsloan
    #     addr_loan = dict_data.get('addr_loan')
    #     if addr_loan is not None:
    #         addr_loan_res = []
    #         for key, value in addr_loan.items():
    #             res = AfAddrloan().addData(value)
    #             addr_loan_res.append(res)
    #         dict_result['addr_loan'] = addr_loan_res
