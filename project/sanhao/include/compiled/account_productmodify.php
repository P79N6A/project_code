	...
	<div class="commodityContent clearfix">
    	<div class="contentMain">
            ...
            <div class="cmc">
            	<div class="box">
                    ...
                    <div class="mc" id="box_up">
                    	<div class="sem"></div>
                    	<div class="sname">
                        	<input type="text" id="product_name" maxlength="30" value="" class="text" /><label for="product_name">请输入您的商品或服务名称</label>
                ...
                <div class="box">
                    ...
                    <div class="mc" id="box_down">
                        ...
                        <div class="sitem">
                        	<?php if($product['endtime'] != ''){?>
                        	<div class="dt"><input type="checkbox" checked id="product_end_time_check" />设置售卖截止日期</div>
                        	<div id="product_end_time" class="dd o"><a href="javascript:void(0)" onclick="WdatePicker({el:$dp.$('product_property_end_time'),minDate:'%y-%M-{%d}'});" class="btn"></a><input readonly id="product_property_end_time" value="<?php echo $product['endtime']; ?>" onclick="WdatePicker({minDate:'%y-%M-{%d}'});" type="text" class="text" /></div>
                        	<?php } else { ?>
            ...
            <input type="hidden" name="product_id" id="product_id" value="<?php echo $product['id']; ?>" />
            	<div class="fore1"><a href="javascript:void(0);" onclick="checkproduct();" class="btn">编辑商品</a></div>
                <?php if($product['status'] ==2){?><div class="fore2"><a href="javascript:void(0);" id="product_add_draft">先存为草稿</a></div><?php }?>
            </div>
        </div>
        <div class="contentSide">
        	<div class="cmh">售卖页面效果预览</div>
            <div class="cmc">
            	<div class="cmm">
                    <div class="name" id="product_name_beta"><?php echo $product['pname']; ?></div>
                    ...
                    <div class="intro">
                        ...
                        <div class="fore2" id="product_content_beta"><?php echo $product['description']; ?></div>
                        <div class="fore3"><a href="javascript:void(0);">发布新商品</a></div>
                    </div>
                </div>
                <div class="cms">
                    <div class="buy">
                        <h3><span id="product_price_beta"><?php echo $product['price']; ?></span></h3>
                        <dl class="item">
                            <dt>数量</dt>
                            <dd>
                    ...
                    <div class="buyt">
                       <dl class="item">
                            ...
                            <dd id="express_price_beta">￥<?php echo $product['express_price']; ?></dd>
                            <?php } else { ?>
		                    <dd id="express_price_beta">￥0.00</dd>
		                 	<?php }?>  
                        </dl>
                        <dl class="item">
                            <dt>库存</dt>
                            <?php if($product['max_number'] != ''){?>
                            <dd id="product_max_number_beta"><?php echo $product['max_number']-$product['sale_number']; ?></dd>
                            <?php } else { ?>
                            <dd id="product_max_number_beta">不限</dd>
                            <?php }?> 
                        </dl>
                        <dl class="item">
                            <dt>剩余时间</dt>
                			...
                			<?php if($left_day>0){?>
                			<dd id="product_end_time_beta"><?php echo $left_day; ?>天<?php echo $left_hour; ?>时<?php echo $left_minute; ?>分<?php echo $left_time; ?>秒</dd>
                			<?php } else { ?>
                			<dd id="product_end_time_beta"><?php echo $left_hour; ?>时<?php echo $left_minute; ?>分<?php echo $left_time; ?>秒</dd>
                    		<?php }?>
                    		<?php } else { ?>
                    		<dd id="product_end_time_beta">已结束</dd>
		                    <?php }?>
		                    <?php }?>
                        </dl>
                    </div>
...
<div class="blank40"></div>
    <script>
	var product = '<?php echo $sproduct;?>' ;
	productstr = eval('('+product+')');
	getproductinformation(productstr);
	</script>
