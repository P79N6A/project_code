...
//获取COOKIE中属性的值
if(isset($_COOKIE['propertyfirst']))
{
	$first_property = $_COOKIE['propertyfirst'];
}
if(isset($_COOKIE['propertysecond']))
{
	$second_property = $_COOKIE['propertysecond'];
}
//获取用户的地址信息
