...
define("XHH_CLIENT_APP_ID",'0701109392016');
define("XHH_CLIENT_AUTH_KEY",'45BCDGHKOQRSUWXYdfgntvwy');
...
class ApiClientCrypt extends ApiCrypt
{
	...
	function __construct(){
		$this->xhApiDomain = SYSTEM_PROD ? Yii::$app->params['xhApiDomain'] : 'http://182.92.80.211:8091/api/';
	}
