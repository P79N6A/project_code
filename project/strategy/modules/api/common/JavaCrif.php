...
class JavaCrif
{
    ...
    const PRO_CODE_CREDIT = 'ANTI_PROME';//智融授信决策
    const PRO_CODE_ALLIN = 'YI_YI_YUAN';//一亿元整合决策
    const PRO_CODE_PROME_TQ = 'prome_tianqi'; // 智融天启决策
    const PRO_CODE_XHH_TQ = 'YI_YI_YUAN_TIANQI'; // 一亿元天启决策
	private $wsdl_url;
