...
class BaseLogic {
     ...
     * @return null
     */
    protected function setReturnInfo($req_data, $crif_res)
    {
        $retData = [
            'mobile'        => ArrayHelper::getValue($req_data,'mobile',''),
            'identity'      => ArrayHelper::getValue($req_data,'identity',''),
            'credit_id'     => ArrayHelper::getValue($req_data,'credit_id',''),
            'credit_result' => ArrayHelper::getValue($crif_res,'RESULT',''),
            'amount'        => ArrayHelper::getValue($crif_res,'AMOUNT',''),
            'days'          => ArrayHelper::getValue($crif_res,'DAYS',''),
        ];
        return $retData;
    }
}