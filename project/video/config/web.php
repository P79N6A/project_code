    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '<controller:rongbaoback>/<action:rongbao>/<env:\w+>' => '<controller>/<action>',
                '<controller:lianback>/<action:liannotify>/<env:\w+>' => '<controller>/<action>',
                '<controller:yjfback>/<action:yjfnotify>/<env:\w+>' => '<controller>/<action>',
                '<controller:bfback>/<action:notify>/<env:\w+>' => '<controller>/<action>',
            ],
        ],
        'memcache' => [
