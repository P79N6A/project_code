...
$key_dir = \Yii::$app->basePath . '/modules/api/common/rongbao/key/prod152/';
//生产环境配置文件
return [
// 商户ID，由纯数字组成的字符串
    'merchant_id' => "100000001301635",
//md5key
    'key' => "88d64a78288g08086ce7833a1ed4af9a42f6g6a35026437220488208a126e1fg",
//签约融宝支付账号或卖家收款融宝支付帐户
    'seller_email' => "guorong@xianhuahua.com",
    'batch_version' => "1.0.0",
    //回调地址
    'notify_url' => 'http://open.xianhuahua.com/rongbaoback/rongbao/prod152',
    //融宝接口地址
