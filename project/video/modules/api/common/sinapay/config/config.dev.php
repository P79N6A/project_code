<?php
     ...
     * 商户号，由新浪支付提供
     */
    define("sinapay_partner_id", "200004595271");//收银台模式商户号
    /**
     * 商户接口字符集，新浪支付接口文档参数
     */
     ...
     * 商户签名私钥，由商户自己生成
     */
    define("sinapay_rsa_sign_private_key", dirname(__File__) . "/../key/dev/rsa_sign_private.pem");//签名私钥
    /**
     * 商户验证签名公钥，由新浪提供
     */
    define("sinapay_rsa_sign_public_key", dirname(__File__) . "/../key/dev/rsa_sign_public.pem");//验证签名公钥
    /**
     * 新浪支付特殊参数加密，公钥，由新浪支付提供
     */
    define("sinapay_rsa_public__key", dirname(__File__) . "/../key/dev/rsa_public.pem");//加密公钥
    /**
