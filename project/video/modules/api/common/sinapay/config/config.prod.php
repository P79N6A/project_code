<?php
     ...
     * 商户号，由新浪支付提供
     */
    define("sinapay_partner_id", "200034807310");//收银台模式商户号
    /**
     * 商户接口字符集，新浪支付接口文档参数
     */
     ...
     * 商户签名私钥，由商户自己生成
     */
    define("sinapay_rsa_sign_private_key", dirname(__File__) . "/../key/prod/rsa_sign_private.pem");//签名私钥
    /**
     * 商户验证签名公钥，由新浪提供
     */
    define("sinapay_rsa_sign_public_key", dirname(__File__) . "/../key/prod/rsa_sign_public.pem");//验证签名公钥
    /**
     * 新浪支付特殊参数加密，公钥，由新浪支付提供
     */
    define("sinapay_rsa_public__key", dirname(__File__) . "/../key/prod/rsa_public.pem");//加密公钥
    /**
     ...
     * 网关地址，接口文档参数
     */
    define("sinapay_mgs_url", "https://gate.pay.sina.com.cn/mgs/gateway.do");//会员类网关地址
    define("sinapay_mas_url", "https://gate.pay.sina.com.cn/mas/gateway.do");//订单类网关地址
    /**
     *
     **/
    ...
    //sftp登录名
    define("sinapay_sftp_Username", "200034807310");
    //sftp登录私钥
