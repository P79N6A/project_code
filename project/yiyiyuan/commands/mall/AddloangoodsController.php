...
/**
 * 生成借款+商品订单
 * linux : sudo -u www /data/wwwroot/yiyiyuan/yii mall/addloangoods
 * windows D:phpStudy\php56n\php.exe D:WWW\yiyiyuanactive\yii mall/addloangoods
 */
...
class AddloangoodsController extends BaseController
{
    private $limit = 200;
    ...
    public function actionIndex()
    {
        ...
        $where = [
            ...
            ['<', User_loan::tableName() . '.create_time', $new_date],
    ...
    public function addLoanGoods($loanList)
    {
        foreach ($loanList as $v){
            ...
            $pay_bill = date("YmdHis") . rand(100000, 999999);
            $data[] = [
                'user_id' => $v->user_id,
