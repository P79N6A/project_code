 ...
 */
class Webunion_account_test extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'yi_webunion_account_test';
    }
    ...
    {
    	$webunion_account = new Webunion_account_test();
    ...
    public function setAccountinfo($user_id, $condition = array()) {
    	...
    	$account = Webunion_account_test::find()->where(['user_id' => $user_id])->one();
