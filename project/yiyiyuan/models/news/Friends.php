 ...
 * @property integer $same_company
 * @property string $school_id
 * @property integer $same_school
...
class Friends extends BaseModel
{
    ...
    {
        return [
            [['user_id', 'fuser_id', 'company', 'modify_time', 'create_time'], 'required'],
            [['user_id', 'fuser_id', 'type', 'auth', 'authed', 'same_company', 'school_id', 'same_school', 'invite', 'like'], 'integer'],
