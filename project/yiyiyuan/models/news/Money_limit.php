...
/**
 * This is the model class for table "yi_money_limit".
 *
 * @property string $id
 ...
 */
class Money_limit extends BaseModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'yi_money_limit';
    }
    ...
    public function todayMaxMoney($channel_id, $type = 1) {
        ...
        $money = Money_limit::find()->select('money')->where($where)->one();
