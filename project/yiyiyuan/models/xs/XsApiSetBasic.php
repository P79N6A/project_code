...
class XsApiSetBasic {
     ...
     */
    public function saveRelation($identity_id, $device, $ip, $event, $aid) {
        ...
        if ($device && $identity_id) {
            ...
            $result = $oDeviceUser->chkAndSave($device, $identity_id, $event, $aid);
            if (!$result) {
        ...
        if ($ip && $identity_id) {
            ...
            $result = $oIpUser->chkAndSave($ip, $identity_id, $event, $aid);
            if (!$result) {
