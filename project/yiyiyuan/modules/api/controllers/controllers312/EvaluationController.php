...
class EvaluationController extends ApiController {
    ...
    public function actionIndex() {
        ...
        $blackBox = Yii::$app->request->post('black_box');
...
//            请前往个人中心完善身份信息
        ...
        $result = $this->postCredit($oJuXinLi->requestid, $oUserCredit, $uuid, $user_id, $deviceTokens,$blackBox,$deviceType, $deviceIp);
        if ($result === false) {
    ...
    private function postCredit($reqId, $oUserCredit, $uuid, $user_id, $deviceTokens,$blackBox,$deviceType, $deviceIp) {
