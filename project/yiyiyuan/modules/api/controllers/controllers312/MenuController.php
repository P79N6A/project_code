...
class MenuController extends ApiController {
    ...
    public function actionIndex() {
        ...
        //我的订单
        $shop_switch = $this->getshopSetting();
        if($shop_switch){
            $menuArr['2'] = [11, 0, 1, 2, 3, 4, 5, 6, 7, 10, 8, 9]; //登录普通用户
        }
    ...
    private function getshopSetting(){
    ...
    private function getAll($user_id = '') {
        ...
        return [
            ...
            2 => [
                'title' => '借款记录',
                'url' => Yii::$app->request->hostInfo .'/borrow/tradinglist/index?user_id=' . $user_id,
            ...
            11 => [
                'title' => '我的订单',
                'url' => $xhshop_url,
                'imgUrl' => $imgBaseUrl . $icoArrList[10],
                'type' => '11',
            ],
        ];
    }
