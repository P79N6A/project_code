	...
	<div class="friends">
		...
		<?php foreach ($v['two'] as $k1 => $v1): ?>
			<section class="list list_del">
				<div class="add"></div>
				<a class="add" href="/background/webunion/three"><img src="/images/on.png" alt="" /></a>
				<a class="icon" href="/background/webunion/detial?user_id=<?php echo $v1['user']['user_id'];?>"><img src="<?php echo $v1['heads'];?>" alt=""/></a>
				<a class="name" href="/background/webunion/detial?user_id=<?php echo $v1['user']['user_id'];?>"><div class=""><?php echo $v1['user']['realname'];?></div></a>
				<a class="phone" href="/background/webunion/detial?user_id=<?php echo $v1['user']['user_id'];?>"><div class=""><?php echo substr_replace($v1['user']['mobile'],'****',3,4);?></div></a>
