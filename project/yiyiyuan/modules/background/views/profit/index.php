		...
		<div class="disitem moneyindex">
        	...
        	<div class="symx_boxb">
	            <div class="disitem symx_gzgz symxgray">
	                <div class="symx_left "><?php echo date('Y年m月',strtotime($month));?>收益</div>
	                <div class="symx_two"></div>
	                <div class="symx_three"><?php echo  number_format($data['total'], 2, ".", "");?>RMB</div>
	                <a href="/background/profit/details?month=<?=$month?>" target="_self">
	                	<img style="width:10px" src="/images/user_right.png"  />
	                </a>
	            </div>
        	</div>
