...
<div class="wrap">
		<div class="index_bg">
			<div class="disitem bg_with">
				<img src="<?php if (empty($userwx)): ?> /images/bigFace.png<?php else: ?><?php echo $userwx->head;?><?php endif; ?>">
				<div>
		...
		<div class="onself_cont friengxq">
			...
			<p><em>手机号</em><?php echo $userinfo->mobile;?></p>
			<p style="border-bottom:0;"><em>职 业&nbsp;&nbsp;</em><?php echo $userinfo->position;?></p>
		</div>
		
		<div class="onself_cont friengxq">
			<p><em>好友状态</em><i><?php echo $arr[$zstatus];?></i></p>
		    <?php if ($zstatus==2): ?> 
