...
<div class="disitem txijl_jikl">
	...
	<div class="disitem txijl_txjl ">
		...
		<span><a href='/background/webunion/liulist'>领取记录</a></span>
	</div>
...
<script>
 $('#mobile').keyup(function () {
   ...
   var mobile = $('#mobile').val();
    $.post("/background/webunion/liusave",{mobile:mobile},function(data){
		$('#flow_amount').html();
		var data = eval("(" + data + ")");
...
$('#incomewd').click(function () {
    	...
    	$.post("/background/webunion/liuincome", {user_id:user_id,flow_amount:flow_amount,mobile:mobile}, function (result) {
