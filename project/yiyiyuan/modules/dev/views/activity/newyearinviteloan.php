...
<div class="yiyyn">
	...
	<div class="bghsezi wanxmes">
		<div class="fqjkh">
			<p class="fqik1">邀请好友发起借款达到10笔后</p>
			<p class="fqik2">中奖率提升100%</p>
		</div>
		<div class="dqayq">当前已完成<?=$friend_loan_num?>笔</div>
		<div class="wcrwu1"><img src="/images/activity/wcrwu3.png"></div>
		<div class="button"> <button class = "yqhy">邀请好友发起借款</button></div>
