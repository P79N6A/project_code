...
<div class="wape">
    ...
    <?php
    $f = array('205', '206', '207', '208', '209', '210', '211', '212', '213', '214', '215');
    if (in_array($come_from, $f)):
        ?>
        <img src="/images/coupon/wafrom.jpg">
        <img src="/images/coupon/wafrom2.jpg">
    <?php else: ?>
    ...
    <p style="position: fixed;bottom:10px; text-align:center; width:100%;color:#c2c2c2;">先花信息技术（北京）有限公司<br/>京ICP备14028045号</p>
</div>
<script>
    $(function() {
            ...
            $.get("/dev/st/statisticssave", {type: 48}, function (data) {
                ...
                $.post('/dev/coupon/sendcoupon', {img_code:imgCode, mobile: mobile, code: code, come_from: come_from, from_code: from_code, val: 66}, function (result) {
                    ...
                    if (data.ret == '-1') {
                        ...
                        window.location.href = '/dev/coupon/sixappsuccess?mobile=' + mobile;
                    } else if (data.ret == 1) {
