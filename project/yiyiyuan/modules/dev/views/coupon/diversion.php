<?php
use app\commands\AdminController;
$admin = new AdminController(1,1);
?>
<style>
    element.style{
        height:100%;
...
<div class="wape">
    ...
    <img src="/images/coupon/wape1_1.png">
    <img src="/images/coupon/wape2_1.png">
    ...
    <div class="selftximg">
        ...
        <!--<div class="dbk_inpL">
            <input placeholder="输入邀请码（可不填）" type="text">
        </div>-->
                ...
                $.post('/dev/coupon/sendcoupon', {img_code:imgCode, mobile: mobile, code: code, come_from: come_from, from_code: from_code, val: 66}, function (result) {
                    ...
                    if (data.ret == '-1') {
                        ...
                        $('#sub').attr('disabled', false);
                            ...
                            window.location.href = '/new/coupon/loan?mobile=' + mobile;
                    } else if (data.ret == 1) {
