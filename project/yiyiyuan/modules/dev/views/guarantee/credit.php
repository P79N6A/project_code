...
<script>
    window.onload = function() {
        ...
        oBtn.onclick = function() {
            if ($('input[name="guarantee_id"]').val().length == 0) {
                alert('数据发生错误了，请重新选择');
...
<div class="Hcontainer nP">
    <div class="main">
                    ...
                    <li class="noBorder">
                        ...
                        <div class="col-xs-9 n26 grey4">
                            <div class="col-xs-6" style="padding-right:5px">
                                <input type="text" name="verifyCode" class="form-control" id="pwd">
                            </div>
                            <div class="col-xs-6">
        ...
        <p class="pay_bank">将跳转至第三方"连连支付"进行银行卡扣款验证</p>
