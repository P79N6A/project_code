<div class="fInvitation">
	...
	<div class="mDatiMask">
	    <div class="mDati">
	        ...
	        <div class="title"><strong>● <?php echo $second_question;?></strong><span>关系铁不铁,就看回答咯</span></div>
	        <ul class="list">
...
<script>
$(".second_click").bind("click",function(){
			   ...
			   if(click_answer == second)
			     {
				   ...
				   window.location = '/dev/invitation/third?userid='+wid+'&key='+array_key;
			     }
			   else
			   	 {
				   //点击错误答案
				   $.post("/dev/invitation/secondsave",{userid: wid,array_key:array_key},function(data){
