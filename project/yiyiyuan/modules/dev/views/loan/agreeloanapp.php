<div class="xieyidm">
    <h3>先花一亿元居间服务及借款协议（三方）<br/><span>（“本协议”）<span style="color:#e74747;">由以下各方于【  <?php echo date('Y'); ?> 】年【 <?php echo date('m'); ?>  】月【 <?php echo date('d'); ?>  】日签订： </span></span></h3>
    <p class="mb20">甲方 (借款方)：<span><?php echo $user['realname']; ?></span></p>
    <!--<p class="mb20">丙方平台用户名：<span><?php if (!empty($userwx) && !empty($userwx['nickname'])): ?><?php echo $userwx['nickname']; ?><?php else: ?><?php echo $user['realname']; ?><?php endif; ?></span></p>-->
    ...
    <table border="1">
        ...
        <tbody>
            <tr>
                ...
                <td>&nbsp;</td>
                <?php
                foreach ($daxie_amount_num as $k => $v) {
                    echo "<td>" . $v . "</td>";
                }
                ?>
            </tr>
            <tr>
                ...
                <td>&nbsp;</td>
                <?php
                foreach ($daxie_repay_amount_num as $k => $v) {
                    echo "<td>" . $v . "</td>";
                }
                ?>
            </tr>
    ...
    <p class="mb20">开户银行：（精确到支行）<?php echo $bank['bank_name']; ?></p>
    <p class="mb20">账号：<?php echo $bank['card']; ?></p>
