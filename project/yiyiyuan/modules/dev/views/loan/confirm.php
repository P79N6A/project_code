...
<div class="Hcontainer">
    ...
    <div class="con">
        <div class="details">
            <div class="adver1 border_bottom_1">
                ...
                <div class="row mb30">
                    ...
                    <div class="col-xs-9 text-right n26"><span class="red">&yen;<?php echo $amount - $withdraw_fee; ?></span></div>
                </div>
                <div class="row mb30">
        ...
        <button type="button" id="loan_confirm" class="btn" style="width:100%;" >确定</button>
    </div>
    <div class="Hmask"></div>
    <div class="layer highlight" style="top:5%">
        <ul class="banksC dBlock">
            ...
            <?php if (!empty($user_bankinfo1)): ?>
                ...
                <?php endforeach; ?>
            <?php endif; ?>
            <p style="border-top:1px solid #c2c2c2; text-align:right; font-size:16px; padding:10px 5%; color:#939ab0; "><a <?php if($bank_count >=10 ): ?>onclick="alert('绑定银行卡已超过10张卡');return false;"<?php else: ?> href="/dev/bank/addcard?url=/dev/loan/second"<?php endif; ?>>添加银行卡</a></p>
        </ul>
    </div>
</div>
