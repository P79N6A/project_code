...
<script type="text/javascript">
    $(function(){
        ...
        $("#addressajax").click(function() {
            ...
            $.post("/mall/index/addressajax", {_csrf:csrf, mobile: mobile, address: address, district: district,  user_id: user_id, user_name: user_name, address_id:address_id}, function(result) {
                var data = eval("(" + result + ")");
                if (data.res_code == 0) {
                    var location_href = "/mall/index/confirmation";
