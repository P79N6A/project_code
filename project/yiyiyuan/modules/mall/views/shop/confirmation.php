<div class="xq_allcont truexqy">
    <div class="add_dizhi">
        <a href="/mall/shop/editaddress?user_id=<?=$userInfo->user_id;?>"><img src="/292/images/add_dzhi.jpg" class="add_dzhi" style="display:none;"></a>
        <a href="/mall/shop/editaddress?user_id=<?=$userInfo->user_id;?>&address_id=<?=$address_info['id'];?>">
...
<script type="text/javascript">
    $(function(){
        ...
        $("#sub").click(function() {
            ...
            $.post("/mall/shop/preorder", {_csrf:csrf, goods_id: goods_id,user_id: user_id, colour:colour, bb:bb, goods_name:goods_name, a_id:a_id, pic_url:pic_url, goods_price:goods_price}, function(result) {
                var data = eval("(" + result + ")");
                if (data.res_code == 0) {
                    var location_href = "/mall/shop/orderdetails?order_id="+data.res_data;
