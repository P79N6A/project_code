...
<div class="jdall">
    <div class="jdyyy danweimes">
        ...
        <div class="dbk_inpL" style="height: 80px;">
            ...
            <div class="add-address" id="addressajax" <?php if( strpos($_SERVER['HTTP_USER_AGENT'], 'YYY_ANDROID') || strpos($_SERVER['HTTP_USER_AGENT'], 'yyyIOS')){ ?> style="margin-bottom: 0px;" <?php }; ?>>保存并使用收货地址</div>
</div>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#addressajax").click(function() {
            ...
            $.post("/mall/store/addressajax", {_csrf:csrf, mobile: mobile, address: address, district: district,  user_id: user_id, user_name: user_name, address_id:address_id}, function(result) {
                var data = eval("(" + result + ")");
                if (data.res_code == 0) {
                    var location_href = "/mall/store/confirmation";
