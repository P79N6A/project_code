...
<script type="text/javascript">
    $(function(){
        ...
        $("#get").click(function() {
            ...
            $.post("/mall/store/getadd", {_csrf:csrf, orderId: orderId}, function(result) {
                var data = eval("(" + result + ")");
                if (data.res_code == 0) {
                    var location_href = "/mall/store/orderdetails?order_id="+orderId;
        ...
        $("#toPay").click(function() {
            ...
            var location_href = href="/mall/store/repaychoose?order_id="+orderId;
            window.location = location_href;
        });
