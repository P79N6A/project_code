...
<div class="xieyidm">
    <h3>电信运营商数据采集服务协议</h3>
    <p>1. 授权商户名称将以下信息包括但不限于姓名、身份证号码和手机号码传递给芝麻信用，用于芝麻信用自行或通过合作机构对你的身份信息进行校验；</p>
    <p>2. 你同意《芝麻服务协议》并开通芝麻信用服务；</p>
    <p>3. 授权商户名称向芝麻信用查询你的芝麻分和相关信用信息，用于评估其与你之间的交易或服务条件。</p>
    <h3></h3>
    <p>特别注意</p>
    <p>当你发生违约或其他影响信用的不良行为时：</p>
    <p>1、你授权芝麻信用可根据商户名称的查询请求，提供可以联系到你的电话号码、地址等联系信息，用于追究违约责任。</p>
