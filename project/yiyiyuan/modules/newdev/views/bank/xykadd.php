...
<div id="tiaozhuan" style="position:fixed; bottom: 20px; text-align: center;width: 100%;color: #ccc;font-size: 14px;">跳过></div>
...
//                $("#remain").html('*请填写正确的短信验证码!');
            ...
            $.post("/new/bank/bindcard?orderinfo='"+orderinfo, {_csrf:_csrf, user_id: user_id, real_name: user_name, identity:identity, card: card_no, mobile: mobile, code: code, banktype: bank_type}, function (result) {
...
//                    $("#remain").html('系统繁忙，请稍后重试');
        ...
        $('#tiaozhuan').click(function() {
            tongji('xyktiaozhuan',baseInfoss);
            $.ajax({
                type: "get",
                url: "/new/bank/tiaozhuan",
                data: {},
