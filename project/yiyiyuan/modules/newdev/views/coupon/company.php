...
<script>
    $(function () {
        $("#company_save").click(function () {
          ...
          $.post("/new/coupon/workinfoajax", {email: $.trim(email), telephone: telephone.trim(), company: company, address: address, industry: industry, profession: profession, position: position, income: income, district: district,  user_id: user_id}, function(result) {
                ...
                if (data.res_code == 0) {
                    if(user_id == ""){
                        ...
                        window.location = '/new/coupon/verify?user_id=' + user_id;
                    }
