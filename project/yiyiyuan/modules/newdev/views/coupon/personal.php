...
//                return false;
//            }
//            $.post("/new/userauth/nameauthajax", {userId: userId, realname: realname, identity: identity, district: district, home_address: home_address, marriage: marriage, edu: edu}, function (result) {
//            alert(csrf);
            $.post("/new/coupon/nameauthajax", {userId: userId, realname: realname, identity: identity, district: district, home_address: home_address, marriage: marriage, edu: edu}, function (result) {
                var data = eval("(" + result + ")");
                console.log(data);
                if (data.res_code == 0) {
                    window.location = '/new/coupon/company?user_id=' + userId;
                } else {
                    alert(data.res_data);
                    return false;
                }
