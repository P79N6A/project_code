...
<!--        <div class="rowym">
    ...
    <?php if ($status != 11): ?>
        <?php if ($loanview == 2): ?>
            <button type="submit" class="bgrey" onclick="doRepay(<?php echo $loan_id; ?>)">我要还款</button>
        <?php elseif ($loanview == 3): ?>
            <button type="submit" class="bgrey" onclick="doRepay(<?php echo $loan_id; ?>)">马上还款</button>
...
<div class="mMenu">
    <ul class="fCf">
        ...
        <li class="item-2"><a href="/mall/store/index"><i class="icon"></i> <em>商城</em></a></li>
...
<script>
        ...
        function doRepay(loan_id) {
            window.location = '/new/repay/repaychoose?loan_id=' + loan_id;
        }
