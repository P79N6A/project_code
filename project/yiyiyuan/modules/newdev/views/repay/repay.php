...
$is_prod = defined(SYSTEM_ENV) && SYSTEM_ENV == 'prod' ? SYSTEM_ENV : 'test';
?>
<div class="container">
        ...
        <div >
            <ul class="way">
                <li style="margin:0;line-height: 24px;">1. 通过银行汇款给先花一亿元账户<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;户&nbsp;&nbsp;&nbsp;名: 萍乡海桐技术服务外包有限公司<br/>
                        支付宝账户: pxht@xianhuahua.com
...
<?php if ($is_prod == 'prod'): ?>
    ...
    <?php else: ?>
    <script src="/js/upload/imguploadnew.js?m=v7" type="text/javascript"></script>
<?php endif; ?>
