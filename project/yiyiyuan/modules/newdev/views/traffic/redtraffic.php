<style>
    ...
    .wape {background: url(/newdev/images/traffic/bgbg2.png) no-repeat; width: 100%; height: 100%; background-size:100% 100%;}
    ...
    .selftximg{position: relative;top:45%; margin:0 4%;border-radius: 0 0 5px 5px; }
    ...
    .selftximg .dbk_inpL.dxyznmes .dxyzn{position: absolute;width: 35%;right: 5%; top: 1.6rem;font-size: 14px; background: rgba(0,0,0,0);color: #d01d1c;border-left: 1px solid #9d9d9d;}
...
<div class="wape">
    <div class="selftximg">
        ...
        <div class="button"> <button id="sub"><img src="/newdev/images/traffic/ljzhuce2.png"></button></div>
        <div class="main">
            <div class="noehtyxh">
