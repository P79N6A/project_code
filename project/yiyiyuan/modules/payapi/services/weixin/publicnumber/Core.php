    ...
    class Core{
        public static function paraFilter(Array $params) {
            ...
            foreach($params as $key => $value){
                ...
                if (($flag==Config::QUERY_FUNCODE)&&!($key==Config::TRADE_SIGNTYPE_KEY||$key==Config::TRADE_SIGNATURE_KEY ||$key==Config::SIGNTYPE_KEY||$key==Config::SIGNATURE_KEY || $key==Config::TRADE_FUNCODE_KEY)) {
                    $result[$key]=$value;
                    continue;
                }
            }
