...
abstract class RenewbaseController extends \app\common\BaseController
{
	// public $layout = 'main';
    static $_appid;
    //= 'wx476bb3649401c450';
    ...
    public function getNextpage($string, $type, $end = 0) {
        $params = Common2::decrypt3Des($string);
    ...
    protected function nextUrl($orderinfo, $current_code, $end = 0, $type = 1) {
        ...
        if ($type == 2) {
            $params = \app\models\news\Common::decrypt3Des($orderinfo);
            $params = json_decode($params, true);
     ...
     * @param $h
     */
    public function getImgCode($num, $w, $h) {
        // 去掉了 0 1 O l 等
