...
<div class="hluan_bg ">
    ...
    <div class="xinxiye">
        ...
        <div class="zhkrq"><span>续期后还款日</span><i><?php echo date('Y-m-d', strtotime(date('Y-m-d')) + $user_loan->days * 86400); ?></i></div>
    </div>
</div>
...
<div class="buttonyi">
    <button onclick="doRenew()" id="do_repay">立即续期</button>
</div>
